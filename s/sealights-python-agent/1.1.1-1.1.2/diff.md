# Comparing `tmp/sealights-python-agent-1.1.1.tar.gz` & `tmp/sealights-python-agent-1.1.2.tar.gz`
...
### Comparing `sealights-python-agent-1.1.1/python_agent/admin.py` & `sealights-python-agent-1.1.2/python_agent/admin.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/bootstrap/sitecustomize.py` & `sealights-python-agent-1.1.2/python_agent/bootstrap/sitecustomize.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/configuration_manager.py` & `sealights-python-agent-1.1.2/python_agent/common/configuration_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/environment_variables_resolver.py` & `sealights-python-agent-1.1.2/python_agent/common/environment_variables_resolver.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/config_data.py` & `sealights-python-agent-1.1.2/python_agent/common/config_data.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/constants.py` & `sealights-python-agent-1.1.2/python_agent/common/constants.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/autoupgrade/autoupgrade_manager.py` & `sealights-python-agent-1.1.2/python_agent/common/autoupgrade/autoupgrade_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/token/token_parser.py` & `sealights-python-agent-1.1.2/python_agent/common/token/token_parser.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/http/backend_proxy.py` & `sealights-python-agent-1.1.2/python_agent/common/http/backend_proxy.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/http/sl_routes.py` & `sealights-python-agent-1.1.2/python_agent/common/http/sl_routes.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/http/requests_wrapper.py` & `sealights-python-agent-1.1.2/python_agent/common/http/requests_wrapper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/agent_events_manager.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/agent_events_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/env_vars.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/env_vars.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/entites/agent_heartbeat_event.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/entites/agent_heartbeat_event.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/entites/agent_footprints_submission_error_event.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/entites/agent_footprints_submission_error_event.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/entites/agent_start_event.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/entites/agent_start_event.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/entites/agent_build_scan_error_event.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/entites/agent_build_scan_error_event.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/agent_events/entites/agent_tests_submission_error_event.py` & `sealights-python-agent-1.1.2/python_agent/common/agent_events/entites/agent_tests_submission_error_event.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/common/log/sealights_logging.py` & `sealights-python-agent-1.1.2/python_agent/common/log/sealights_logging.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/utils.py` & `sealights-python-agent-1.1.2/python_agent/utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/queues/events_queue.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/queues/events_queue.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/queues/footprints_queue.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/queues/footprints_queue.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/web_frameworks/bottle_framework.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/web_frameworks/bottle_framework.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/web_frameworks/flask_framework.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/web_frameworks/flask_framework.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/coloring/requests_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/coloring/requests_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/coloring/selenium_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/coloring/selenium_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/coloring/urllib2_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/coloring/urllib2_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/managers/tia_manager.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/managers/tia_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/managers/code_coverage_manager.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/managers/code_coverage_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/managers/agent_manager.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/managers/agent_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/managers/footprints_manager.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/managers/footprints_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/managers/events_manager.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/managers/events_manager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/sealights_api.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/sealights_api.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/services/footprints_service.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/services/footprints_service.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/services/events_service.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/services/events_service.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/line_footprints_collector.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/line_footprints_collector.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/utils.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/method_footprints_collector.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/method_footprints_collector.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/integrations/freezegun_patcher.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/integrations/freezegun_patcher.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/integrations/multiprocessing_patcher.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/integrations/multiprocessing_patcher.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/integrations/pytest_xdist_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/integrations/pytest_xdist_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/integrations/unittest_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/integrations/unittest_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/integrations/nose_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/integrations/nose_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/integrations/pytest_helper.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/integrations/pytest_helper.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/entities/upload_reports_metadata.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/entities/upload_reports_metadata.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/test_frameworks/agent_execution.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/test_frameworks/agent_execution.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/test_frameworks/pytest_execution.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/test_frameworks/pytest_execution.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/test_frameworks/unittest_execution.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/test_frameworks/unittest_execution.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/test_frameworks/nose_execution.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/test_frameworks/nose_execution.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/upload_reports.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/upload_reports.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/start_execution.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/start_execution.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/run.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/run.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/send_footprints.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/send_footprints.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/executors/anonymous_execution.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/executors/anonymous_execution.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/test_listener/state_tracker.py` & `sealights-python-agent-1.1.2/python_agent/test_listener/state_tracker.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/__init__.py` & `sealights-python-agent-1.1.2/python_agent/__init__.py`
...
### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/scm/git_integration.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/scm/git_integration.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/scm/scm_info.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/scm/scm_info.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/file_scanner.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/file_scanner.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/visitors.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/visitors.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/app.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/app.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/ast_utils.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/ast_utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/method_hasher.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/method_hasher.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/entities/environment_data.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/entities/environment_data.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/entities/v3/method_data.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/entities/v3/method_data.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/entities/v3/file_data.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/entities/v3/file_data.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/executors/build.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/executors/build.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/build_scanner/executors/config.py` & `sealights-python-agent-1.1.2/python_agent/build_scanner/executors/config.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/init.py` & `sealights-python-agent-1.1.2/python_agent/init.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/blinker/_utilities.py` & `sealights-python-agent-1.1.2/python_agent/packages/blinker/_utilities.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/blinker/base.py` & `sealights-python-agent-1.1.2/python_agent/packages/blinker/base.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/blinker/_saferef.py` & `sealights-python-agent-1.1.2/python_agent/packages/blinker/_saferef.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/adapters.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/adapters.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/exceptions.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/exceptions.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/packages.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/packages.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/models.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/models.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/api.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/api.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/hooks.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/hooks.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/cookies.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/cookies.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/auth.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/auth.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/utils.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/help.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/help.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/_internal_utils.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/_internal_utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/status_codes.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/status_codes.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/structures.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/structures.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/compat.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/compat.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/requests/sessions.py` & `sealights-python-agent-1.1.2/python_agent/packages/requests/sessions.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/six.py` & `sealights-python-agent-1.1.2/python_agent/packages/six.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/certifi/cacert.pem` & `sealights-python-agent-1.1.2/python_agent/packages/certifi/cacert.pem`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/certifi/core.py` & `sealights-python-agent-1.1.2/python_agent/packages/certifi/core.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/api_jws.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/api_jws.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/exceptions.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/exceptions.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/jwks_client.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/jwks_client.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/api_jwt.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/api_jwt.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/algorithms.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/algorithms.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/api_jwk.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/api_jwk.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/utils.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/help.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/help.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/jwt/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/jwt/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/__main__.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/__main__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/unparser36.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/unparser36.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/unparser38.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/unparser38.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/printer.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/printer.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/unparser.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/unparser.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astunparse/unparser37.py` & `sealights-python-agent-1.1.2/python_agent/packages/astunparse/unparser37.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/string_repr.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/string_repr.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/code_gen.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/code_gen.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/file_util.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/file_util.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/source_repr.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/source_repr.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/node_util.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/node_util.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/rtrip.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/rtrip.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/tree_walk.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/tree_walk.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/astor/op_util.py` & `sealights-python-agent-1.1.2/python_agent/packages/astor/op_util.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/typing_extensions.py` & `sealights-python-agent-1.1.2/python_agent/packages/typing_extensions.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_adapters.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_adapters.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_text.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_text.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_collections.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_collections.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_compat.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_compat.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_functools.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_functools.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_meta.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_meta.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/_itertools.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/_itertools.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/importlib_metadata/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/importlib_metadata/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/zipp.py` & `sealights-python-agent-1.1.2/python_agent/packages/zipp.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/_textwrap.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/_textwrap.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/exceptions.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/exceptions.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/testing.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/testing.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/types.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/types.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/_termui_impl.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/_termui_impl.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/_compat.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/_compat.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/_unicodefun.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/_unicodefun.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/_winconsole.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/_winconsole.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/globals.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/globals.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/utils.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/parser.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/parser.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/core.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/core.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/decorators.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/decorators.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/formatting.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/formatting.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/shell_completion.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/shell_completion.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/click/termui.py` & `sealights-python-agent-1.1.2/python_agent/packages/click/termui.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/cd.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/cd.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/legacy.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/legacy.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/models.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/models.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/assets/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/assets/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/cli/normalizer.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/cli/normalizer.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/api.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/api.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/md.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/md.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/utils.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/utils.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/charset_normalizer/constant.py` & `sealights-python-agent-1.1.2/python_agent/packages/charset_normalizer/constant.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/semantic_version/base.py` & `sealights-python-agent-1.1.2/python_agent/packages/semantic_version/base.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/semantic_version/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/semantic_version/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/semantic_version/django_fields.py` & `sealights-python-agent-1.1.2/python_agent/packages/semantic_version/django_fields.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/idna/codec.py` & `sealights-python-agent-1.1.2/python_agent/packages/idna/codec.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/idna/intranges.py` & `sealights-python-agent-1.1.2/python_agent/packages/idna/intranges.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/idna/uts46data.py` & `sealights-python-agent-1.1.2/python_agent/packages/idna/uts46data.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/idna/idnadata.py` & `sealights-python-agent-1.1.2/python_agent/packages/idna/idnadata.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/idna/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/idna/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/idna/core.py` & `sealights-python-agent-1.1.2/python_agent/packages/idna/core.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/exceptions.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/exceptions.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/response.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/response.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/fields.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/fields.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/connectionpool.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/connectionpool.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/poolmanager.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/poolmanager.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/_collections.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/_collections.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/filepost.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/filepost.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/connection.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/connection.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/ssl_match_hostname.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/ssl_match_hostname.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/ssltransport.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/ssltransport.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/response.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/response.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/proxy.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/proxy.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/ssl_.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/ssl_.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/wait.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/wait.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/timeout.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/timeout.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/connection.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/connection.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/request.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/request.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/retry.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/retry.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/util/url.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/util/url.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/request.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/request.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/ntlmpool.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/ntlmpool.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/_securetransport/low_level.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/_securetransport/low_level.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/_securetransport/bindings.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/_securetransport/bindings.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/securetransport.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/securetransport.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/pyopenssl.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/pyopenssl.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/_appengine_environ.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/_appengine_environ.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/appengine.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/appengine.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/contrib/socks.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/contrib/socks.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/__init__.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/__init__.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/packages/six.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/packages/six.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/urllib3/packages/backports/makefile.py` & `sealights-python-agent-1.1.2/python_agent/packages/urllib3/packages/backports/makefile.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/python_agent/packages/freezegun/api.py` & `sealights-python-agent-1.1.2/python_agent/packages/freezegun/api.py`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/LICENSE.txt` & `sealights-python-agent-1.1.2/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/sealights_python_agent.egg-info/SOURCES.txt` & `sealights-python-agent-1.1.2/sealights_python_agent.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/sealights_python_agent.egg-info/requires.txt` & `sealights-python-agent-1.1.2/sealights_python_agent.egg-info/requires.txt`
...
### Comparing `sealights-python-agent-1.1.1/sealights_python_agent.egg-info/PKG-INFO` & `sealights-python-agent-1.1.2/sealights_python_agent.egg-info/PKG-INFO`
...
### Comparing `sealights-python-agent-1.1.1/CHANGES.rst` & `sealights-python-agent-1.1.2/CHANGES.rst`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/README.rst` & `sealights-python-agent-1.1.2/README.rst`

 * *Files identical despite different names*

### Comparing `sealights-python-agent-1.1.1/PKG-INFO` & `sealights-python-agent-1.1.2/PKG-INFO`
...
### Comparing `sealights-python-agent-1.1.1/setup.py` & `sealights-python-agent-1.1.2/setup.py`
