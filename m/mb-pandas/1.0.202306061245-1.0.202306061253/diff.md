# Comparing `tmp/mb_pandas-1.0.202306061245-py3-none-any.whl.zip` & `tmp/mb_pandas-1.0.202306061253-py3-none-any.whl.zip`
...
## Comparing `mb_pandas-1.0.202306061245.data/scripts/df_profile` & `mb_pandas-1.0.202306061253.data/scripts/df_profile`
...
## Comparing `mb_pandas-1.0.202306061245.data/scripts/df_view` & `mb_pandas-1.0.202306061253.data/scripts/df_view`

 * *Files identical despite different names*

## Comparing `mb_pandas-1.0.202306061245.dist-info/RECORD` & `mb_pandas-1.0.202306061253.dist-info/RECORD`
