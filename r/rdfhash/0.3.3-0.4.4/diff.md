# Comparing `tmp/rdfhash-0.3.3.tar.gz` & `tmp/rdfhash-0.4.4.tar.gz`
...
## Comparing `rdfhash-0.3.3.tar` & `rdfhash-0.4.4.tar`
...
### Comparing `rdfhash-0.3.3/PKG-INFO` & `rdfhash-0.4.4/PKG-INFO`
...
### Comparing `rdfhash-0.3.3/README.md` & `rdfhash-0.4.4/README.md`

 * *Files identical despite different names*

### Comparing `rdfhash-0.3.3/package/hash.py` & `rdfhash-0.4.4/rdfhash/main.py`
...
### Comparing `rdfhash-0.3.3/package/logger.py` & `rdfhash-0.4.4/rdfhash/logger.py`

 * *Files identical despite different names*

### Comparing `rdfhash-0.3.3/rdfhash.egg-info/PKG-INFO` & `rdfhash-0.4.4/rdfhash.egg-info/PKG-INFO`
...
### Comparing `rdfhash-0.3.3/setup.py` & `rdfhash-0.4.4/setup.py`
