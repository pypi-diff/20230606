# Comparing `tmp/AstroInstrumentAD-0.11.tar.gz` & `tmp/AstroInstrumentAD-0.12.tar.gz`
...
## Comparing `AstroInstrumentAD-0.11.tar` & `AstroInstrumentAD-0.12.tar`
...
### Comparing `AstroInstrumentAD-0.11/AstroInstrumentAD/dispersion_analysis.py` & `AstroInstrumentAD-0.12/AstroInstrumentAD/dispersion_analysis.py`
...
### Comparing `AstroInstrumentAD-0.11/AstroInstrumentAD/dispersion_functions.py` & `AstroInstrumentAD-0.12/AstroInstrumentAD/dispersion_functions.py`

 * *Files identical despite different names*

### Comparing `AstroInstrumentAD-0.11/AstroInstrumentAD.egg-info/PKG-INFO` & `AstroInstrumentAD-0.12/AstroInstrumentAD.egg-info/PKG-INFO`
...
### Comparing `AstroInstrumentAD-0.11/PKG-INFO` & `AstroInstrumentAD-0.12/PKG-INFO`
...
### Comparing `AstroInstrumentAD-0.11/setup.py` & `AstroInstrumentAD-0.12/setup.py`
