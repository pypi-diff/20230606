# Comparing `tmp/NikChat-2.2.tar.gz` & `tmp/NikChat-2.2.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "NikChat-2.2.tar", last modified: Tue Jun  6 00:17:58 2023, max compression
+gzip compressed data, was "NikChat-2.2.1.tar", last modified: Tue Jun  6 00:48:24 2023, max compression
```

## Comparing `NikChat-2.2.tar` & `NikChat-2.2.1.tar`

### file list

```diff
@@ -1,11 +1,11 @@
-drwxrwxrwx   0        0        0        0 2023-06-06 00:17:58.021825 NikChat-2.2/
--rw-rw-rw-   0        0        0     1094 2023-05-19 05:37:20.000000 NikChat-2.2/LICENSE
-drwxrwxrwx   0        0        0        0 2023-06-06 00:17:58.017824 NikChat-2.2/NikChat.egg-info/
--rw-rw-rw-   0        0        0     1676 2023-06-06 00:17:57.000000 NikChat-2.2/NikChat.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      166 2023-06-06 00:17:57.000000 NikChat-2.2/NikChat.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-06-06 00:17:57.000000 NikChat-2.2/NikChat.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        1 2023-06-06 00:17:57.000000 NikChat-2.2/NikChat.egg-info/top_level.txt
--rw-rw-rw-   0        0        0     1676 2023-06-06 00:17:58.022333 NikChat-2.2/PKG-INFO
--rw-rw-rw-   0        0        0     1147 2023-05-24 05:16:40.000000 NikChat-2.2/README.md
--rw-rw-rw-   0        0        0      100 2023-05-21 16:11:11.000000 NikChat-2.2/pyproject.toml
--rw-rw-rw-   0        0        0      631 2023-06-06 00:17:58.026352 NikChat-2.2/setup.cfg
+drwxrwxrwx   0        0        0        0 2023-06-06 00:48:24.155041 NikChat-2.2.1/
+-rw-rw-rw-   0        0        0     1094 2023-05-19 05:37:20.000000 NikChat-2.2.1/LICENSE
+drwxrwxrwx   0        0        0        0 2023-06-06 00:48:24.140515 NikChat-2.2.1/NikChat.egg-info/
+-rw-rw-rw-   0        0        0     1678 2023-06-06 00:48:23.000000 NikChat-2.2.1/NikChat.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      166 2023-06-06 00:48:23.000000 NikChat-2.2.1/NikChat.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-06-06 00:48:23.000000 NikChat-2.2.1/NikChat.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0        1 2023-06-06 00:48:23.000000 NikChat-2.2.1/NikChat.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0     1678 2023-06-06 00:48:24.156034 NikChat-2.2.1/PKG-INFO
+-rw-rw-rw-   0        0        0     1147 2023-05-24 05:16:40.000000 NikChat-2.2.1/README.md
+-rw-rw-rw-   0        0        0      100 2023-05-21 16:11:11.000000 NikChat-2.2.1/pyproject.toml
+-rw-rw-rw-   0        0        0      633 2023-06-06 00:48:24.164035 NikChat-2.2.1/setup.cfg
```

### Comparing `NikChat-2.2/LICENSE` & `NikChat-2.2.1/LICENSE`

 * *Files identical despite different names*

### Comparing `NikChat-2.2/NikChat.egg-info/PKG-INFO` & `NikChat-2.2.1/NikChat.egg-info/PKG-INFO`
...
### Comparing `NikChat-2.2/PKG-INFO` & `NikChat-2.2.1/PKG-INFO`
...
### Comparing `NikChat-2.2/README.md` & `NikChat-2.2.1/README.md`

 * *Files identical despite different names*

### Comparing `NikChat-2.2/setup.cfg` & `NikChat-2.2.1/setup.cfg`
...
-00000020: 696f 6e20 3d20 322e 320d 0a61 7574 686f  ion = 2.2..autho
...
-00000130: 7874 2f6d 6172 6b64 6f77 6e0d 0a48 6f6d  xt/markdown..Hom
-00000140: 652d 7061 6765 203d 2068 7474 7073 3a2f  e-page = https:/
...
-00000220: 6972 6573 203d 203e 3d33 2e38 0d0a 696e  ires = >=3.8..in
...
+00000020: 696f 6e20 3d20 322e 322e 310d 0a61 7574  ion = 2.2.1..aut
...
+00000130: 7465 7874 2f6d 6172 6b64 6f77 6e0d 0a48  text/markdown..H
+00000140: 6f6d 652d 7061 6765 203d 2068 7474 7073  ome-page = https
...
+00000220: 7175 6972 6573 203d 203e 3d33 2e38 0d0a  quires = >=3.8..
