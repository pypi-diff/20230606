# Comparing `tmp/BroadSword-0.0.7.tar.gz` & `tmp/BroadSword-0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "BroadSword-0.0.7.tar", last modified: Tue Jun  6 21:40:06 2023, max compression
+gzip compressed data, was "BroadSword-0.1.tar", last modified: Tue Jun  6 17:57:37 2023, max compression
```

## Comparing `BroadSword-0.0.7.tar` & `BroadSword-0.1.tar`

### file list

```diff
@@ -1,19 +1,16 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 21:40:06.984084 BroadSword-0.0.7/
--rw-r--r--   0 runner    (1001) docker     (123)     1068 2023-06-06 21:39:57.000000 BroadSword-0.0.7/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)      678 2023-06-06 21:40:06.984084 BroadSword-0.0.7/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       56 2023-06-06 21:39:57.000000 BroadSword-0.0.7/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      104 2023-06-06 21:39:57.000000 BroadSword-0.0.7/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)      894 2023-06-06 21:40:06.984084 BroadSword-0.0.7/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 21:40:06.984084 BroadSword-0.0.7/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 21:40:06.984084 BroadSword-0.0.7/src/BroadSword/
--rw-r--r--   0 runner    (1001) docker     (123)    16658 2023-06-06 21:39:57.000000 BroadSword-0.0.7/src/BroadSword/BroadSword.py
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-06 21:39:57.000000 BroadSword-0.0.7/src/BroadSword/__init__.py
--rwxr-xr-x   0 runner    (1001) docker     (123)    21008 2023-06-06 21:39:57.000000 BroadSword-0.0.7/src/BroadSword/libmatrices.dylib
--rwxr-xr-x   0 runner    (1001) docker     (123)    20496 2023-06-06 21:39:57.000000 BroadSword-0.0.7/src/BroadSword/libmatrices.so
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 21:40:06.984084 BroadSword-0.0.7/src/BroadSword.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      678 2023-06-06 21:40:06.000000 BroadSword-0.0.7/src/BroadSword.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      383 2023-06-06 21:40:06.000000 BroadSword-0.0.7/src/BroadSword.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-06 21:40:06.000000 BroadSword-0.0.7/src/BroadSword.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       29 2023-06-06 21:40:06.000000 BroadSword-0.0.7/src/BroadSword.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-06-06 21:40:06.000000 BroadSword-0.0.7/src/BroadSword.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-06 21:40:06.000000 BroadSword-0.0.7/src/BroadSword.egg-info/zip-safe
...
### Comparing `BroadSword-0.0.7/LICENSE` & `BroadSword-0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `BroadSword-0.0.7/PKG-INFO` & `BroadSword-0.1/PKG-INFO`
...
### Comparing `BroadSword-0.0.7/setup.cfg` & `BroadSword-0.1/setup.cfg`
...
### Comparing `BroadSword-0.0.7/src/BroadSword/BroadSword.py` & `BroadSword-0.1/src/BroadSword/BroadSword.py`
...
### Comparing `BroadSword-0.0.7/src/BroadSword.egg-info/PKG-INFO` & `BroadSword-0.1/src/BroadSword.egg-info/PKG-INFO`
