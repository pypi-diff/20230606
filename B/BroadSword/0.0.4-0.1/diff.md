# Comparing `tmp/BroadSword-0.0.4.tar.gz` & `tmp/BroadSword-0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "BroadSword-0.0.4.tar", last modified: Tue Jun  6 20:31:34 2023, max compression
+gzip compressed data, was "BroadSword-0.1.tar", last modified: Tue Jun  6 17:57:37 2023, max compression
```

## Comparing `BroadSword-0.0.4.tar` & `BroadSword-0.1.tar`

### file list

```diff
@@ -1,18 +1,16 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 20:31:34.945403 BroadSword-0.0.4/
--rw-r--r--   0 runner    (1001) docker     (123)     1068 2023-06-06 20:31:24.000000 BroadSword-0.0.4/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)      678 2023-06-06 20:31:34.945403 BroadSword-0.0.4/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       56 2023-06-06 20:31:24.000000 BroadSword-0.0.4/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      104 2023-06-06 20:31:24.000000 BroadSword-0.0.4/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)      889 2023-06-06 20:31:34.945403 BroadSword-0.0.4/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 20:31:34.945403 BroadSword-0.0.4/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 20:31:34.945403 BroadSword-0.0.4/src/BroadSword/
--rw-r--r--   0 runner    (1001) docker     (123)    16537 2023-06-06 20:31:24.000000 BroadSword-0.0.4/src/BroadSword/BroadSword.py
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-06 20:31:24.000000 BroadSword-0.0.4/src/BroadSword/__init__.py
--rwxr-xr-x   0 runner    (1001) docker     (123)    20496 2023-06-06 20:31:24.000000 BroadSword-0.0.4/src/BroadSword/libmatrices.so
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-06 20:31:34.945403 BroadSword-0.0.4/src/BroadSword.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      678 2023-06-06 20:31:34.000000 BroadSword-0.0.4/src/BroadSword.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      350 2023-06-06 20:31:34.000000 BroadSword-0.0.4/src/BroadSword.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-06 20:31:34.000000 BroadSword-0.0.4/src/BroadSword.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       32 2023-06-06 20:31:34.000000 BroadSword-0.0.4/src/BroadSword.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-06-06 20:31:34.000000 BroadSword-0.0.4/src/BroadSword.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-06 20:31:34.000000 BroadSword-0.0.4/src/BroadSword.egg-info/zip-safe
...
### Comparing `BroadSword-0.0.4/LICENSE` & `BroadSword-0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `BroadSword-0.0.4/PKG-INFO` & `BroadSword-0.1/PKG-INFO`
...
### Comparing `BroadSword-0.0.4/setup.cfg` & `BroadSword-0.1/setup.cfg`
...
### Comparing `BroadSword-0.0.4/src/BroadSword/BroadSword.py` & `BroadSword-0.1/src/BroadSword/BroadSword.py`
...
### Comparing `BroadSword-0.0.4/src/BroadSword.egg-info/PKG-INFO` & `BroadSword-0.1/src/BroadSword.egg-info/PKG-INFO`
