# Comparing `tmp/faKy-1.3.1.tar.gz` & `tmp/faKy-1.3.2.tar.gz`
...
## Comparing `faKy-1.3.1.tar` & `faKy-1.3.2.tar`
...
### Comparing `faKy-1.3.1/faKy/faKy.py` & `faKy-1.3.2/faKy/faKy.py`

 * *Files identical despite different names*

### Comparing `faKy-1.3.1/setup.py` & `faKy-1.3.2/setup.py`
