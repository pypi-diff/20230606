# Comparing `tmp/pulumi_pulumiservice-0.7.3a1685755724.tar.gz` & `tmp/pulumi_pulumiservice-0.8.0.tar.gz`
...
## Comparing `pulumi_pulumiservice-0.7.3a1685755724.tar` & `pulumi_pulumiservice-0.8.0.tar`
...
### Comparing `pulumi_pulumiservice-0.7.3a1685755724/PKG-INFO` & `pulumi_pulumiservice-0.8.0/PKG-INFO`
...
### Comparing `pulumi_pulumiservice-0.7.3a1685755724/README.md` & `pulumi_pulumiservice-0.8.0/README.md`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/__init__.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/__init__.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/_enums.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/_enums.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/_inputs.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/_inputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/_utilities.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/_utilities.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/access_token.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/access_token.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/config/vars.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/config/vars.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/deployment_settings.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/deployment_settings.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/org_access_token.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/org_access_token.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/provider.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/provider.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/stack_tag.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/stack_tag.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/team.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/team.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/team_access_token.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/team_access_token.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/team_stack_permission.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/team_stack_permission.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice/webhook.py` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice/webhook.py`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice.egg-info/PKG-INFO` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice.egg-info/PKG-INFO`
...
### Comparing `pulumi_pulumiservice-0.7.3a1685755724/pulumi_pulumiservice.egg-info/SOURCES.txt` & `pulumi_pulumiservice-0.8.0/pulumi_pulumiservice.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pulumi_pulumiservice-0.7.3a1685755724/setup.py` & `pulumi_pulumiservice-0.8.0/setup.py`
