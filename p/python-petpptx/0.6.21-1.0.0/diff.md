# Comparing `tmp/python-petpptx-0.6.21.tar.gz` & `tmp/python-petpptx-1.0.0.tar.gz`
...
--rw-rw-rw-   0        0        0     9269 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/text/test_layout.py
--rw-rw-rw-   0        0        0    46965 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/text/test_text.py
--rw-rw-rw-   0        0        0     3785 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/unitdata.py
-drwxrwxrwx   0        0        0        0 2023-06-06 09:50:41.857975 python-petpptx-0.6.21/tests/unitutil/
--rw-rw-rw-   0        0        0      262 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/unitutil/__init__.py
--rw-rw-rw-   0        0        0     8597 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/unitutil/cxml.py
--rw-rw-rw-   0        0        0     1919 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/unitutil/file.py
--rw-rw-rw-   0        0        0     4243 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tests/unitutil/mock.py
--rw-rw-rw-   0        0        0      689 2023-06-06 09:05:39.000000 python-petpptx-0.6.21/tox.ini
...
### Comparing `python-petpptx-0.6.21/HISTORY.rst` & `python-petpptx-1.0.0/HISTORY.rst`
...
### Comparing `python-petpptx-0.6.21/LICENSE` & `python-petpptx-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/PKG-INFO` & `python-petpptx-1.0.0/PKG-INFO`
...
### Comparing `python-petpptx-0.6.21/README.rst` & `python-petpptx-1.0.0/README.rst`
...
### Comparing `python-petpptx-0.6.21/features/act-action.feature` & `python-petpptx-1.0.0/features/act-action.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/act-hyperlink.feature` & `python-petpptx-1.0.0/features/act-hyperlink.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-axis-props.feature` & `python-petpptx-1.0.0/features/cht-axis-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-axistitle-props.feature` & `python-petpptx-1.0.0/features/cht-axistitle-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-category-access.feature` & `python-petpptx-1.0.0/features/cht-category-access.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-category-props.feature` & `python-petpptx-1.0.0/features/cht-category-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-chart.feature` & `python-petpptx-1.0.0/features/cht-chart.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-charttitle-props.feature` & `python-petpptx-1.0.0/features/cht-charttitle-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-data-props.feature` & `python-petpptx-1.0.0/features/cht-data-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-datalabels.feature` & `python-petpptx-1.0.0/features/cht-datalabels.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-legend-access.feature` & `python-petpptx-1.0.0/features/cht-legend-access.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-legend-props.feature` & `python-petpptx-1.0.0/features/cht-legend-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-marker-props.feature` & `python-petpptx-1.0.0/features/cht-marker-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-plot-props.feature` & `python-petpptx-1.0.0/features/cht-plot-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-point-access.feature` & `python-petpptx-1.0.0/features/cht-point-access.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-point-props.feature` & `python-petpptx-1.0.0/features/cht-point-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-replace-data.feature` & `python-petpptx-1.0.0/features/cht-replace-data.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-series.feature` & `python-petpptx-1.0.0/features/cht-series.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/cht-ticklabels-props.feature` & `python-petpptx-1.0.0/features/cht-ticklabels-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/dml-color.feature` & `python-petpptx-1.0.0/features/dml-color.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/dml-effect.feature` & `python-petpptx-1.0.0/features/dml-effect.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/dml-fill.feature` & `python-petpptx-1.0.0/features/dml-fill.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/dml-line.feature` & `python-petpptx-1.0.0/features/dml-line.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/environment.py` & `python-petpptx-1.0.0/features/environment.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/ph-inherit-props.feature` & `python-petpptx-1.0.0/features/ph-inherit-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/ph-insert-shape.feature` & `python-petpptx-1.0.0/features/ph-insert-shape.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/ph-phfmt-props.feature` & `python-petpptx-1.0.0/features/ph-phfmt-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/ph-placeholder-props.feature` & `python-petpptx-1.0.0/features/ph-placeholder-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/prs-coreprops.feature` & `python-petpptx-1.0.0/features/prs-coreprops.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/prs-open-save.feature` & `python-petpptx-1.0.0/features/prs-open-save.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/prs-presentation-props.feature` & `python-petpptx-1.0.0/features/prs-presentation-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-autoshape.feature` & `python-petpptx-1.0.0/features/shp-autoshape.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-connector.feature` & `python-petpptx-1.0.0/features/shp-connector.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-freeform.feature` & `python-petpptx-1.0.0/features/shp-freeform.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-graphicframe.feature` & `python-petpptx-1.0.0/features/shp-graphicframe.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-groupshape.feature` & `python-petpptx-1.0.0/features/shp-groupshape.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-movie-props.feature` & `python-petpptx-1.0.0/features/shp-movie-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-picture.feature` & `python-petpptx-1.0.0/features/shp-picture.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-placeholder.feature` & `python-petpptx-1.0.0/features/shp-placeholder.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-shapes.feature` & `python-petpptx-1.0.0/features/shp-shapes.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/shp-shared.feature` & `python-petpptx-1.0.0/features/shp-shared.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/sld-slide.feature` & `python-petpptx-1.0.0/features/sld-slide.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/sld-slides.feature` & `python-petpptx-1.0.0/features/sld-slides.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/action.py` & `python-petpptx-1.0.0/features/steps/action.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/axis.py` & `python-petpptx-1.0.0/features/steps/axis.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/background.py` & `python-petpptx-1.0.0/features/steps/background.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/category.py` & `python-petpptx-1.0.0/features/steps/category.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/chart.py` & `python-petpptx-1.0.0/features/steps/chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/chartdata.py` & `python-petpptx-1.0.0/features/steps/chartdata.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/color.py` & `python-petpptx-1.0.0/features/steps/color.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/coreprops.py` & `python-petpptx-1.0.0/features/steps/coreprops.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/datalabel.py` & `python-petpptx-1.0.0/features/steps/datalabel.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/effect.py` & `python-petpptx-1.0.0/features/steps/effect.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/fill.py` & `python-petpptx-1.0.0/features/steps/fill.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/font.py` & `python-petpptx-1.0.0/features/steps/font.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/font_color.py` & `python-petpptx-1.0.0/features/steps/font_color.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/helpers.py` & `python-petpptx-1.0.0/features/steps/helpers.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/legend.py` & `python-petpptx-1.0.0/features/steps/legend.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/line.py` & `python-petpptx-1.0.0/features/steps/line.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/picture.py` & `python-petpptx-1.0.0/features/steps/picture.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/placeholder.py` & `python-petpptx-1.0.0/features/steps/placeholder.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/plot.py` & `python-petpptx-1.0.0/features/steps/plot.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/presentation.py` & `python-petpptx-1.0.0/features/steps/presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/series.py` & `python-petpptx-1.0.0/features/steps/series.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/shape.py` & `python-petpptx-1.0.0/features/steps/shape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/shapes.py` & `python-petpptx-1.0.0/features/steps/shapes.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/slide.py` & `python-petpptx-1.0.0/features/steps/slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/slides.py` & `python-petpptx-1.0.0/features/steps/slides.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/table.py` & `python-petpptx-1.0.0/features/steps/table.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/72-dpi.tiff` & `python-petpptx-1.0.0/features/steps/test_files/72-dpi.tiff`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/CVS_LOGO.WMF` & `python-petpptx-1.0.0/features/steps/test_files/CVS_LOGO.WMF`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/act-props.pptm` & `python-petpptx-1.0.0/features/steps/test_files/act-props.pptm`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/calibriz.ttf` & `python-petpptx-1.0.0/features/steps/test_files/calibriz.ttf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-axis-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-axis-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-category-access.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-category-access.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-chart-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-chart-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-chart-type.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-chart-type.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-charts.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-charts.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-datalabels.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-datalabels.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-gridlines-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-gridlines-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-legend-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-legend-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-legend.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-legend.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-marker-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-marker-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-plot-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-plot-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-point-access.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-point-access.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-point-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-point-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-replace-data.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-replace-data.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-series.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-series.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/cht-ticklabels-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/cht-ticklabels-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/dml-effect.pptx` & `python-petpptx-1.0.0/features/steps/test_files/dml-effect.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/dml-fill.pptx` & `python-petpptx-1.0.0/features/steps/test_files/dml-fill.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/dml-line.pptx` & `python-petpptx-1.0.0/features/steps/test_files/dml-line.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/ext-rels.pptx` & `python-petpptx-1.0.0/features/steps/test_files/ext-rels.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/[Content_Types].xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/[Content_Types].xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/_rels/.rels` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/_rels/.rels`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/docProps/app.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/docProps/app.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/docProps/core.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/docProps/core.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/docProps/thumbnail.jpeg` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/docProps/thumbnail.jpeg`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/_rels/presentation.xml.rels` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/_rels/presentation.xml.rels`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/presProps.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/presProps.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/presentation.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/presentation.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/printerSettings/printerSettings1.bin` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/printerSettings/printerSettings1.bin`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout1.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout10.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout10.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout11.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout11.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout2.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout2.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout3.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout3.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout4.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout4.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout5.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout5.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout6.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout6.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout7.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout7.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout8.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout8.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout9.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideLayouts/slideLayout9.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideMasters/_rels/slideMaster1.xml.rels` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideMasters/_rels/slideMaster1.xml.rels`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slideMasters/slideMaster1.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slideMasters/slideMaster1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/slides/slide1.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/slides/slide1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/theme/theme1.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/theme/theme1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/extracted-pptx/ppt/viewProps.xml` & `python-petpptx-1.0.0/features/steps/test_files/extracted-pptx/ppt/viewProps.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/font-color.pptx` & `python-petpptx-1.0.0/features/steps/test_files/font-color.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/just-two-mice.mp4` & `python-petpptx-1.0.0/features/steps/test_files/just-two-mice.mp4`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/just-two-mice.png` & `python-petpptx-1.0.0/features/steps/test_files/just-two-mice.png`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/lyt-shapes.pptx` & `python-petpptx-1.0.0/features/steps/test_files/lyt-shapes.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/minimal.pptx` & `python-petpptx-1.0.0/features/steps/test_files/minimal.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/monty-truth.png` & `python-petpptx-1.0.0/features/steps/test_files/monty-truth.png`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/mst-placeholders.pptx` & `python-petpptx-1.0.0/features/steps/test_files/mst-placeholders.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/mst-shapes.pptx` & `python-petpptx-1.0.0/features/steps/test_files/mst-shapes.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/mst-slide-layouts.pptx` & `python-petpptx-1.0.0/features/steps/test_files/mst-slide-layouts.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/ph-inherit-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/ph-inherit-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/ph-populated-placeholders.pptx` & `python-petpptx-1.0.0/features/steps/test_files/ph-populated-placeholders.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/ph-unpopulated-placeholders.pptx` & `python-petpptx-1.0.0/features/steps/test_files/ph-unpopulated-placeholders.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/pic.emf` & `python-petpptx-1.0.0/features/steps/test_files/pic.emf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/prs-add-slide.pptx` & `python-petpptx-1.0.0/features/steps/test_files/prs-add-slide.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/prs-notes.pptx` & `python-petpptx-1.0.0/features/steps/test_files/prs-notes.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/prs-properties.pptx` & `python-petpptx-1.0.0/features/steps/test_files/prs-properties.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/prs-slide-masters.pptx` & `python-petpptx-1.0.0/features/steps/test_files/prs-slide-masters.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/python-icon.jpeg` & `python-petpptx-1.0.0/features/steps/test_files/python-icon.jpeg`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/python-powered.png` & `python-petpptx-1.0.0/features/steps/test_files/python-powered.png`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/python.bmp` & `python-petpptx-1.0.0/features/steps/test_files/python.bmp`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-access-chart.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-access-chart.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-access-ole-object.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-access-ole-object.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-autoshape-adjustments.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-autoshape-adjustments.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-autoshape-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-autoshape-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-common-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-common-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-connector-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-connector-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-embedded-docx.docx` & `python-petpptx-1.0.0/features/steps/test_files/shp-embedded-docx.docx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-embedded-pptx.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-embedded-pptx.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-embedded-xlsx.xlsx` & `python-petpptx-1.0.0/features/steps/test_files/shp-embedded-xlsx.xlsx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-freeform.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-freeform.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-groupshape.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-groupshape.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-movie-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-movie-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-picture.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-picture.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-pos-and-size.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-pos-and-size.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/shp-shapes.pptx` & `python-petpptx-1.0.0/features/steps/test_files/shp-shapes.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/sld-background.pptx` & `python-petpptx-1.0.0/features/steps/test_files/sld-background.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/sld-blank.pptx` & `python-petpptx-1.0.0/features/steps/test_files/sld-blank.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/sld-notes.pptx` & `python-petpptx-1.0.0/features/steps/test_files/sld-notes.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/sld-slide.pptx` & `python-petpptx-1.0.0/features/steps/test_files/sld-slide.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/sld-slides.pptx` & `python-petpptx-1.0.0/features/steps/test_files/sld-slides.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/sonic.gif` & `python-petpptx-1.0.0/features/steps/test_files/sonic.gif`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/tbl-cell.pptx` & `python-petpptx-1.0.0/features/steps/test_files/tbl-cell.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/test.pptx` & `python-petpptx-1.0.0/features/steps/test_files/test.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/txt-fit-text.pptx` & `python-petpptx-1.0.0/features/steps/test_files/txt-fit-text.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/txt-font-props.pptx` & `python-petpptx-1.0.0/features/steps/test_files/txt-font-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/txt-font-typeface.pptx` & `python-petpptx-1.0.0/features/steps/test_files/txt-font-typeface.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/txt-paragraph-spacing.pptx` & `python-petpptx-1.0.0/features/steps/test_files/txt-paragraph-spacing.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/txt-text-frame.pptx` & `python-petpptx-1.0.0/features/steps/test_files/txt-text-frame.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/test_files/txt-text.pptx` & `python-petpptx-1.0.0/features/steps/test_files/txt-text.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/text.py` & `python-petpptx-1.0.0/features/steps/text.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/steps/text_frame.py` & `python-petpptx-1.0.0/features/steps/text_frame.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/tbl-cell.feature` & `python-petpptx-1.0.0/features/tbl-cell.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/tbl-table.feature` & `python-petpptx-1.0.0/features/tbl-table.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/txt-font-color.feature` & `python-petpptx-1.0.0/features/txt-font-color.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/txt-font-props.feature` & `python-petpptx-1.0.0/features/txt-font-props.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/txt-paragraph.feature` & `python-petpptx-1.0.0/features/txt-paragraph.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/txt-text.feature` & `python-petpptx-1.0.0/features/txt-text.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/features/txt-textframe.feature` & `python-petpptx-1.0.0/features/txt-textframe.feature`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/__init__.py` & `python-petpptx-1.0.0/pptx/__init__.py`
...
### Comparing `python-petpptx-0.6.21/pptx/action.py` & `python-petpptx-1.0.0/pptx/action.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/api.py` & `python-petpptx-1.0.0/pptx/api.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/axis.py` & `python-petpptx-1.0.0/pptx/chart/axis.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/category.py` & `python-petpptx-1.0.0/pptx/chart/category.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/chart.py` & `python-petpptx-1.0.0/pptx/chart/chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/data.py` & `python-petpptx-1.0.0/pptx/chart/data.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/datalabel.py` & `python-petpptx-1.0.0/pptx/chart/datalabel.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/legend.py` & `python-petpptx-1.0.0/pptx/chart/legend.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/marker.py` & `python-petpptx-1.0.0/pptx/chart/marker.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/plot.py` & `python-petpptx-1.0.0/pptx/chart/plot.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/point.py` & `python-petpptx-1.0.0/pptx/chart/point.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/series.py` & `python-petpptx-1.0.0/pptx/chart/series.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/xlsx.py` & `python-petpptx-1.0.0/pptx/chart/xlsx.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/chart/xmlwriter.py` & `python-petpptx-1.0.0/pptx/chart/xmlwriter.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/compat/__init__.py` & `python-petpptx-1.0.0/pptx/compat/__init__.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/compat/python2.py` & `python-petpptx-1.0.0/pptx/compat/python2.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/compat/python3.py` & `python-petpptx-1.0.0/pptx/compat/python3.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/dml/chtfmt.py` & `python-petpptx-1.0.0/pptx/dml/chtfmt.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/dml/color.py` & `python-petpptx-1.0.0/pptx/dml/color.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/dml/effect.py` & `python-petpptx-1.0.0/pptx/dml/effect.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/dml/fill.py` & `python-petpptx-1.0.0/pptx/dml/fill.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/dml/line.py` & `python-petpptx-1.0.0/pptx/dml/line.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/action.py` & `python-petpptx-1.0.0/pptx/enum/action.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/base.py` & `python-petpptx-1.0.0/pptx/enum/base.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/chart.py` & `python-petpptx-1.0.0/pptx/enum/chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/dml.py` & `python-petpptx-1.0.0/pptx/enum/dml.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/lang.py` & `python-petpptx-1.0.0/pptx/enum/lang.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/shapes.py` & `python-petpptx-1.0.0/pptx/enum/shapes.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/enum/text.py` & `python-petpptx-1.0.0/pptx/enum/text.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/media.py` & `python-petpptx-1.0.0/pptx/media.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/constants.py` & `python-petpptx-1.0.0/pptx/opc/constants.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/oxml.py` & `python-petpptx-1.0.0/pptx/opc/oxml.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/package.py` & `python-petpptx-1.0.0/pptx/opc/package.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/packuri.py` & `python-petpptx-1.0.0/pptx/opc/packuri.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/serialized.py` & `python-petpptx-1.0.0/pptx/opc/serialized.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/shared.py` & `python-petpptx-1.0.0/pptx/opc/shared.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/opc/spec.py` & `python-petpptx-1.0.0/pptx/opc/spec.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/__init__.py` & `python-petpptx-1.0.0/pptx/oxml/__init__.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/action.py` & `python-petpptx-1.0.0/pptx/oxml/action.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/axis.py` & `python-petpptx-1.0.0/pptx/oxml/chart/axis.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/chart.py` & `python-petpptx-1.0.0/pptx/oxml/chart/chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/datalabel.py` & `python-petpptx-1.0.0/pptx/oxml/chart/datalabel.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/legend.py` & `python-petpptx-1.0.0/pptx/oxml/chart/legend.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/marker.py` & `python-petpptx-1.0.0/pptx/oxml/chart/marker.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/plot.py` & `python-petpptx-1.0.0/pptx/oxml/chart/plot.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/series.py` & `python-petpptx-1.0.0/pptx/oxml/chart/series.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/chart/shared.py` & `python-petpptx-1.0.0/pptx/oxml/chart/shared.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/coreprops.py` & `python-petpptx-1.0.0/pptx/oxml/coreprops.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/dml/color.py` & `python-petpptx-1.0.0/pptx/oxml/dml/color.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/dml/fill.py` & `python-petpptx-1.0.0/pptx/oxml/dml/fill.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/ns.py` & `python-petpptx-1.0.0/pptx/oxml/ns.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/presentation.py` & `python-petpptx-1.0.0/pptx/oxml/presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/shapes/autoshape.py` & `python-petpptx-1.0.0/pptx/oxml/shapes/autoshape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/shapes/connector.py` & `python-petpptx-1.0.0/pptx/oxml/shapes/connector.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/shapes/graphfrm.py` & `python-petpptx-1.0.0/pptx/oxml/shapes/graphfrm.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/shapes/groupshape.py` & `python-petpptx-1.0.0/pptx/oxml/shapes/groupshape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/shapes/picture.py` & `python-petpptx-1.0.0/pptx/oxml/shapes/picture.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/shapes/shared.py` & `python-petpptx-1.0.0/pptx/oxml/shapes/shared.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/simpletypes.py` & `python-petpptx-1.0.0/pptx/oxml/simpletypes.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/slide.py` & `python-petpptx-1.0.0/pptx/oxml/slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/table.py` & `python-petpptx-1.0.0/pptx/oxml/table.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/text.py` & `python-petpptx-1.0.0/pptx/oxml/text.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/theme.py` & `python-petpptx-1.0.0/pptx/oxml/theme.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/oxml/xmlchemy.py` & `python-petpptx-1.0.0/pptx/oxml/xmlchemy.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/package.py` & `python-petpptx-1.0.0/pptx/package.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/chart.py` & `python-petpptx-1.0.0/pptx/parts/chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/coreprops.py` & `python-petpptx-1.0.0/pptx/parts/coreprops.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/embeddedpackage.py` & `python-petpptx-1.0.0/pptx/parts/embeddedpackage.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/image.py` & `python-petpptx-1.0.0/pptx/parts/image.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/media.py` & `python-petpptx-1.0.0/pptx/parts/media.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/presentation.py` & `python-petpptx-1.0.0/pptx/parts/presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/parts/slide.py` & `python-petpptx-1.0.0/pptx/parts/slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/presentation.py` & `python-petpptx-1.0.0/pptx/presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/__init__.py` & `python-petpptx-1.0.0/pptx/shapes/__init__.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/autoshape.py` & `python-petpptx-1.0.0/pptx/shapes/autoshape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/base.py` & `python-petpptx-1.0.0/pptx/shapes/base.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/connector.py` & `python-petpptx-1.0.0/pptx/shapes/connector.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/freeform.py` & `python-petpptx-1.0.0/pptx/shapes/freeform.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/graphfrm.py` & `python-petpptx-1.0.0/pptx/shapes/graphfrm.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/group.py` & `python-petpptx-1.0.0/pptx/shapes/group.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/picture.py` & `python-petpptx-1.0.0/pptx/shapes/picture.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/placeholder.py` & `python-petpptx-1.0.0/pptx/shapes/placeholder.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shapes/shapetree.py` & `python-petpptx-1.0.0/pptx/shapes/shapetree.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/shared.py` & `python-petpptx-1.0.0/pptx/shared.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/slide.py` & `python-petpptx-1.0.0/pptx/slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/spec.py` & `python-petpptx-1.0.0/pptx/spec.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/table.py` & `python-petpptx-1.0.0/pptx/table.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/default.pptx` & `python-petpptx-1.0.0/pptx/templates/default.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/docx-icon.emf` & `python-petpptx-1.0.0/pptx/templates/docx-icon.emf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/generic-icon.emf` & `python-petpptx-1.0.0/pptx/templates/generic-icon.emf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/notes.xml` & `python-petpptx-1.0.0/pptx/templates/notes.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/notesMaster.xml` & `python-petpptx-1.0.0/pptx/templates/notesMaster.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/pptx-icon.emf` & `python-petpptx-1.0.0/pptx/templates/pptx-icon.emf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/theme.xml` & `python-petpptx-1.0.0/pptx/templates/theme.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/templates/xlsx-icon.emf` & `python-petpptx-1.0.0/pptx/templates/xlsx-icon.emf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/text/fonts.py` & `python-petpptx-1.0.0/pptx/text/fonts.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/text/layout.py` & `python-petpptx-1.0.0/pptx/text/layout.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/text/text.py` & `python-petpptx-1.0.0/pptx/text/text.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/pptx/util.py` & `python-petpptx-1.0.0/pptx/util.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/python_petpptx.egg-info/PKG-INFO` & `python-petpptx-1.0.0/python_petpptx.egg-info/PKG-INFO`
...
### Comparing `python-petpptx-0.6.21/python_petpptx.egg-info/SOURCES.txt` & `python-petpptx-1.0.0/python_petpptx.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/setup.py` & `python-petpptx-1.0.0/setup.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_axis.py` & `python-petpptx-1.0.0/tests/chart/test_axis.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_category.py` & `python-petpptx-1.0.0/tests/chart/test_category.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_chart.py` & `python-petpptx-1.0.0/tests/chart/test_chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_data.py` & `python-petpptx-1.0.0/tests/chart/test_data.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_datalabel.py` & `python-petpptx-1.0.0/tests/chart/test_datalabel.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_legend.py` & `python-petpptx-1.0.0/tests/chart/test_legend.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_marker.py` & `python-petpptx-1.0.0/tests/chart/test_marker.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_plot.py` & `python-petpptx-1.0.0/tests/chart/test_plot.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_point.py` & `python-petpptx-1.0.0/tests/chart/test_point.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_series.py` & `python-petpptx-1.0.0/tests/chart/test_series.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_xlsx.py` & `python-petpptx-1.0.0/tests/chart/test_xlsx.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/chart/test_xmlwriter.py` & `python-petpptx-1.0.0/tests/chart/test_xmlwriter.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/dml/test_chtfmt.py` & `python-petpptx-1.0.0/tests/dml/test_chtfmt.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/dml/test_color.py` & `python-petpptx-1.0.0/tests/dml/test_color.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/dml/test_effect.py` & `python-petpptx-1.0.0/tests/dml/test_effect.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/dml/test_fill.py` & `python-petpptx-1.0.0/tests/dml/test_fill.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/dml/test_line.py` & `python-petpptx-1.0.0/tests/dml/test_line.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/opc/test_oxml.py` & `python-petpptx-1.0.0/tests/opc/test_oxml.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/opc/test_package.py` & `python-petpptx-1.0.0/tests/opc/test_package.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/opc/test_packuri.py` & `python-petpptx-1.0.0/tests/opc/test_packuri.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/opc/test_serialized.py` & `python-petpptx-1.0.0/tests/opc/test_serialized.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/opc/unitdata/rels.py` & `python-petpptx-1.0.0/tests/opc/unitdata/rels.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/shapes/test_autoshape.py` & `python-petpptx-1.0.0/tests/oxml/shapes/test_autoshape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/shapes/test_graphfrm.py` & `python-petpptx-1.0.0/tests/oxml/shapes/test_graphfrm.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/shapes/test_groupshape.py` & `python-petpptx-1.0.0/tests/oxml/shapes/test_groupshape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/shapes/test_picture.py` & `python-petpptx-1.0.0/tests/oxml/shapes/test_picture.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test___init__.py` & `python-petpptx-1.0.0/tests/oxml/test___init__.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_dml.py` & `python-petpptx-1.0.0/tests/oxml/test_dml.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_ns.py` & `python-petpptx-1.0.0/tests/oxml/test_ns.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_presentation.py` & `python-petpptx-1.0.0/tests/oxml/test_presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_simpletypes.py` & `python-petpptx-1.0.0/tests/oxml/test_simpletypes.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_slide.py` & `python-petpptx-1.0.0/tests/oxml/test_slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_table.py` & `python-petpptx-1.0.0/tests/oxml/test_table.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_theme.py` & `python-petpptx-1.0.0/tests/oxml/test_theme.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/test_xmlchemy.py` & `python-petpptx-1.0.0/tests/oxml/test_xmlchemy.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/unitdata/dml.py` & `python-petpptx-1.0.0/tests/oxml/unitdata/dml.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/unitdata/shape.py` & `python-petpptx-1.0.0/tests/oxml/unitdata/shape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/oxml/unitdata/text.py` & `python-petpptx-1.0.0/tests/oxml/unitdata/text.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_chart.py` & `python-petpptx-1.0.0/tests/parts/test_chart.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_coreprops.py` & `python-petpptx-1.0.0/tests/parts/test_coreprops.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_embeddedpackage.py` & `python-petpptx-1.0.0/tests/parts/test_embeddedpackage.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_image.py` & `python-petpptx-1.0.0/tests/parts/test_image.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_media.py` & `python-petpptx-1.0.0/tests/parts/test_media.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_presentation.py` & `python-petpptx-1.0.0/tests/parts/test_presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/parts/test_slide.py` & `python-petpptx-1.0.0/tests/parts/test_slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_autoshape.py` & `python-petpptx-1.0.0/tests/shapes/test_autoshape.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_base.py` & `python-petpptx-1.0.0/tests/shapes/test_base.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_connector.py` & `python-petpptx-1.0.0/tests/shapes/test_connector.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_freeform.py` & `python-petpptx-1.0.0/tests/shapes/test_freeform.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_graphfrm.py` & `python-petpptx-1.0.0/tests/shapes/test_graphfrm.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_group.py` & `python-petpptx-1.0.0/tests/shapes/test_group.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_picture.py` & `python-petpptx-1.0.0/tests/shapes/test_picture.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_placeholder.py` & `python-petpptx-1.0.0/tests/shapes/test_placeholder.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/shapes/test_shapetree.py` & `python-petpptx-1.0.0/tests/shapes/test_shapetree.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_action.py` & `python-petpptx-1.0.0/tests/test_action.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_api.py` & `python-petpptx-1.0.0/tests/test_api.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_enum.py` & `python-petpptx-1.0.0/tests/test_enum.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/calibriz.ttf` & `python-petpptx-1.0.0/tests/test_files/calibriz.ttf`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/cdw-logo.eps` & `python-petpptx-1.0.0/tests/test_files/cdw-logo.eps`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/[Content_Types].xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/[Content_Types].xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/_rels/.rels` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/_rels/.rels`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/docProps/app.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/docProps/app.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/docProps/core.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/docProps/core.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/docProps/thumbnail.jpeg` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/docProps/thumbnail.jpeg`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/_rels/presentation.xml.rels` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/_rels/presentation.xml.rels`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/presentation.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/presentation.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/printerSettings/printerSettings1.bin` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/printerSettings/printerSettings1.bin`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout1.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout10.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout10.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout11.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout11.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout2.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout2.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout3.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout3.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout4.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout4.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout5.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout5.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout6.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout6.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout7.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout7.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout8.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout8.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout9.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideLayouts/slideLayout9.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideMasters/_rels/slideMaster1.xml.rels` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideMasters/_rels/slideMaster1.xml.rels`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slideMasters/slideMaster1.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slideMasters/slideMaster1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/slides/slide1.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/slides/slide1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/theme/theme1.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/theme/theme1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/expanded_pptx/ppt/viewProps.xml` & `python-petpptx-1.0.0/tests/test_files/expanded_pptx/ppt/viewProps.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/minimal.pptx` & `python-petpptx-1.0.0/tests/test_files/minimal.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/missing_rels_item.pptx` & `python-petpptx-1.0.0/tests/test_files/missing_rels_item.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/monty-truth.png` & `python-petpptx-1.0.0/tests/test_files/monty-truth.png`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/no-core-props.pptx` & `python-petpptx-1.0.0/tests/test_files/no-core-props.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/no-slides.pptx` & `python-petpptx-1.0.0/tests/test_files/no-slides.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/presentation.xml` & `python-petpptx-1.0.0/tests/test_files/presentation.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/python-icon.jpeg` & `python-petpptx-1.0.0/tests/test_files/python-icon.jpeg`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/python-powered.png` & `python-petpptx-1.0.0/tests/test_files/python-powered.png`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/python.bmp` & `python-petpptx-1.0.0/tests/test_files/python.bmp`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/slideLayout1.xml` & `python-petpptx-1.0.0/tests/test_files/slideLayout1.xml`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-area-date.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-area-date.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-area-float.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-area-float.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-area-stacked-100.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-area-stacked-100.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-area-stacked.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-area-stacked.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-area.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-area.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-bar-clustered-date.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-bar-clustered-date.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-bar-clustered-float.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-bar-clustered-float.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-bar-clustered.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-bar-clustered.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-bar-stacked-100.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-bar-stacked-100.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-bar-stacked.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-bar-stacked.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-column-clustered.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-column-clustered.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-column-stacked-100.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-column-stacked-100.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-column-stacked.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-column-stacked.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-date.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-date.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-float.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-float.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-markers-stacked-100.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-markers-stacked-100.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-markers-stacked.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-markers-stacked.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-markers.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-markers.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-stacked-100.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-stacked-100.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line-stacked.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line-stacked.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x2-line.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x2-line.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-bubble-3d.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-bubble-3d.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-bubble.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-bubble.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-xy-lines-no-markers.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-xy-lines-no-markers.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-xy-lines.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-xy-lines.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-xy-smooth-no-markers.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-xy-smooth-no-markers.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-xy-smooth.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-xy-smooth.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x3-xy.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x3-xy.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/2x5-radar.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/2x5-radar.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/3x1-pie-exploded.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/3x1-pie-exploded.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/3x1-pie.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/3x1-pie.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/3x2-doughnut-exploded.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/3x2-doughnut-exploded.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/3x2-doughnut.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/3x2-doughnut.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/4x2-multi-cat-bar.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/4x2-multi-cat-bar.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/adjust-ser-count.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/adjust-ser-count.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/cat-labels.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/cat-labels.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/content-types-xml.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/content-types-xml.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/default-notes.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/default-notes.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/default-notesMaster.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/default-notesMaster.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/default-theme.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/default-theme.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/freeform.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/freeform.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/package-rels-xml.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/package-rels-xml.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/placeholders.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/placeholders.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/presentation-rels-xml.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/presentation-rels-xml.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/rels-load-from-xml.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/rels-load-from-xml.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/rewrite-ser.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/rewrite-ser.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/snippets/timing.txt` & `python-petpptx-1.0.0/tests/test_files/snippets/timing.txt`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/test.pptx` & `python-petpptx-1.0.0/tests/test_files/test.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_files/test_slides.pptx` & `python-petpptx-1.0.0/tests/test_files/test_slides.pptx`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_media.py` & `python-petpptx-1.0.0/tests/test_media.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_package.py` & `python-petpptx-1.0.0/tests/test_package.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_presentation.py` & `python-petpptx-1.0.0/tests/test_presentation.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_shared.py` & `python-petpptx-1.0.0/tests/test_shared.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_slide.py` & `python-petpptx-1.0.0/tests/test_slide.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_table.py` & `python-petpptx-1.0.0/tests/test_table.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/test_util.py` & `python-petpptx-1.0.0/tests/test_util.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/text/test_fonts.py` & `python-petpptx-1.0.0/tests/text/test_fonts.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/text/test_layout.py` & `python-petpptx-1.0.0/tests/text/test_layout.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/text/test_text.py` & `python-petpptx-1.0.0/tests/text/test_text.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/unitdata.py` & `python-petpptx-1.0.0/tests/unitdata.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/unitutil/cxml.py` & `python-petpptx-1.0.0/tests/unitutil/cxml.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/unitutil/file.py` & `python-petpptx-1.0.0/tests/unitutil/file.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tests/unitutil/mock.py` & `python-petpptx-1.0.0/tests/unitutil/mock.py`

 * *Files identical despite different names*

### Comparing `python-petpptx-0.6.21/tox.ini` & `python-petpptx-1.0.0/tox.ini`
