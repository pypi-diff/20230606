# Comparing `tmp/portage-3.0.48.tar.gz` & `tmp/portage-3.0.48.1.tar.gz`
...
### Comparing `portage-3.0.48/DEVELOPING` & `portage-3.0.48.1/DEVELOPING`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/LICENSE` & `portage-3.0.48.1/LICENSE`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/PKG-INFO` & `portage-3.0.48.1/PKG-INFO`
...
### Comparing `portage-3.0.48/TEST-NOTES` & `portage-3.0.48.1/TEST-NOTES`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/archive-conf` & `portage-3.0.48.1/bin/archive-conf`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/bashrc-functions.sh` & `portage-3.0.48.1/bin/bashrc-functions.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/binhost-snapshot` & `portage-3.0.48.1/bin/binhost-snapshot`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/chmod-lite.py` & `portage-3.0.48.1/bin/chmod-lite.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/chpathtool.py` & `portage-3.0.48.1/bin/chpathtool.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/clean_locks` & `portage-3.0.48.1/bin/clean_locks`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/dispatch-conf` & `portage-3.0.48.1/bin/dispatch-conf`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/dohtml.py` & `portage-3.0.48.1/bin/dohtml.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/doins.py` & `portage-3.0.48.1/bin/doins.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/eapi.sh` & `portage-3.0.48.1/bin/eapi.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/eapi7-ver-funcs.sh` & `portage-3.0.48.1/bin/eapi7-ver-funcs.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild` & `portage-3.0.48.1/bin/ebuild`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/bsd/sed` & `portage-3.0.48.1/bin/ebuild-helpers/bsd/sed`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dobin` & `portage-3.0.48.1/bin/ebuild-helpers/dobin`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doconfd` & `portage-3.0.48.1/bin/ebuild-helpers/doconfd`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dodoc` & `portage-3.0.48.1/bin/ebuild-helpers/dodoc`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doenvd` & `portage-3.0.48.1/bin/ebuild-helpers/doenvd`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doexe` & `portage-3.0.48.1/bin/ebuild-helpers/doexe`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dohard` & `portage-3.0.48.1/bin/ebuild-helpers/dohard`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doheader` & `portage-3.0.48.1/bin/ebuild-helpers/doheader`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dohtml` & `portage-3.0.48.1/bin/ebuild-helpers/dohtml`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doinfo` & `portage-3.0.48.1/bin/ebuild-helpers/doinfo`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doins` & `portage-3.0.48.1/bin/ebuild-helpers/doins`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dolib` & `portage-3.0.48.1/bin/ebuild-helpers/dolib`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/doman` & `portage-3.0.48.1/bin/ebuild-helpers/doman`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/domo` & `portage-3.0.48.1/bin/ebuild-helpers/domo`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dosbin` & `portage-3.0.48.1/bin/ebuild-helpers/dosbin`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dosed` & `portage-3.0.48.1/bin/ebuild-helpers/dosed`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/dosym` & `portage-3.0.48.1/bin/ebuild-helpers/dosym`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/emake` & `portage-3.0.48.1/bin/ebuild-helpers/emake`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/fowners` & `portage-3.0.48.1/bin/ebuild-helpers/fowners`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/fperms` & `portage-3.0.48.1/bin/ebuild-helpers/fperms`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/newins` & `portage-3.0.48.1/bin/ebuild-helpers/newins`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/prepinfo` & `portage-3.0.48.1/bin/ebuild-helpers/prepinfo`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/unprivileged/chown` & `portage-3.0.48.1/bin/ebuild-helpers/unprivileged/chown`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-helpers/xattr/install` & `portage-3.0.48.1/bin/ebuild-helpers/xattr/install`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-ipc.py` & `portage-3.0.48.1/bin/ebuild-ipc.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild-pyhelper` & `portage-3.0.48.1/bin/ebuild-pyhelper`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ebuild.sh` & `portage-3.0.48.1/bin/ebuild.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ecompress` & `portage-3.0.48.1/bin/ecompress`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/ecompress-file` & `portage-3.0.48.1/bin/ecompress-file`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/egencache` & `portage-3.0.48.1/bin/egencache`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/emaint` & `portage-3.0.48.1/bin/emaint`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/emerge` & `portage-3.0.48.1/bin/emerge`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/emerge-webrsync` & `portage-3.0.48.1/bin/emerge-webrsync`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/emirrordist` & `portage-3.0.48.1/bin/emirrordist`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/env-update` & `portage-3.0.48.1/bin/env-update`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/estrip` & `portage-3.0.48.1/bin/estrip`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/etc-update` & `portage-3.0.48.1/bin/etc-update`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/filter-bash-environment.py` & `portage-3.0.48.1/bin/filter-bash-environment.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/fixpackages` & `portage-3.0.48.1/bin/fixpackages`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/glsa-check` & `portage-3.0.48.1/bin/glsa-check`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/gpkg-helper.py` & `portage-3.0.48.1/bin/gpkg-helper.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/gpkg-sign` & `portage-3.0.48.1/bin/gpkg-sign`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/helper-functions.sh` & `portage-3.0.48.1/bin/helper-functions.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/05prefix` & `portage-3.0.48.1/bin/install-qa-check.d/05prefix`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/10executable-issues` & `portage-3.0.48.1/bin/install-qa-check.d/10executable-issues`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/10ignored-flags` & `portage-3.0.48.1/bin/install-qa-check.d/10ignored-flags`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/20runtime-directories` & `portage-3.0.48.1/bin/install-qa-check.d/20runtime-directories`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/60bash-completion` & `portage-3.0.48.1/bin/install-qa-check.d/60bash-completion`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/60openrc` & `portage-3.0.48.1/bin/install-qa-check.d/60openrc`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/60pkgconfig` & `portage-3.0.48.1/bin/install-qa-check.d/60pkgconfig`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/60pngfix` & `portage-3.0.48.1/bin/install-qa-check.d/60pngfix`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/60systemd` & `portage-3.0.48.1/bin/install-qa-check.d/60systemd`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/80libraries` & `portage-3.0.48.1/bin/install-qa-check.d/80libraries`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/80multilib-strict` & `portage-3.0.48.1/bin/install-qa-check.d/80multilib-strict`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90bad-bin-group-write` & `portage-3.0.48.1/bin/install-qa-check.d/90bad-bin-group-write`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90bad-bin-owner` & `portage-3.0.48.1/bin/install-qa-check.d/90bad-bin-owner`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90cmake-warnings` & `portage-3.0.48.1/bin/install-qa-check.d/90cmake-warnings`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90config-impl-decl` & `portage-3.0.48.1/bin/install-qa-check.d/90config-impl-decl`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90cython-dep` & `portage-3.0.48.1/bin/install-qa-check.d/90cython-dep`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90gcc-warnings` & `portage-3.0.48.1/bin/install-qa-check.d/90gcc-warnings`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/90world-writable` & `portage-3.0.48.1/bin/install-qa-check.d/90world-writable`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install-qa-check.d/95empty-dirs` & `portage-3.0.48.1/bin/install-qa-check.d/95empty-dirs`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/install.py` & `portage-3.0.48.1/bin/install.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/isolated-functions.sh` & `portage-3.0.48.1/bin/isolated-functions.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/lock-helper.py` & `portage-3.0.48.1/bin/lock-helper.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/misc-functions.sh` & `portage-3.0.48.1/bin/misc-functions.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/phase-functions.sh` & `portage-3.0.48.1/bin/phase-functions.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/phase-helpers.sh` & `portage-3.0.48.1/bin/phase-helpers.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/pid-ns-init` & `portage-3.0.48.1/bin/pid-ns-init`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/portageq` & `portage-3.0.48.1/bin/portageq`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/portageq-wrapper` & `portage-3.0.48.1/bin/portageq-wrapper`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/postinst-qa-check.d/50xdg-utils` & `portage-3.0.48.1/bin/postinst-qa-check.d/50xdg-utils`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/quickpkg` & `portage-3.0.48.1/bin/quickpkg`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/regenworld` & `portage-3.0.48.1/bin/regenworld`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/save-ebuild-env.sh` & `portage-3.0.48.1/bin/save-ebuild-env.sh`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/shelve-utils` & `portage-3.0.48.1/bin/shelve-utils`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/socks5-server.py` & `portage-3.0.48.1/bin/socks5-server.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/xattr-helper.py` & `portage-3.0.48.1/bin/xattr-helper.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/bin/xpak-helper.py` & `portage-3.0.48.1/bin/xpak-helper.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.alpha.diff` & `portage-3.0.48.1/cnf/make.conf.example.alpha.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.amd64-fbsd.diff` & `portage-3.0.48.1/cnf/make.conf.example.amd64-fbsd.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.amd64.diff` & `portage-3.0.48.1/cnf/make.conf.example.amd64.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.arm.diff` & `portage-3.0.48.1/cnf/make.conf.example.arm.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.arm64.diff` & `portage-3.0.48.1/cnf/make.conf.example.arm64.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.hppa.diff` & `portage-3.0.48.1/cnf/make.conf.example.hppa.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.ia64.diff` & `portage-3.0.48.1/cnf/make.conf.example.ia64.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.loong.diff` & `portage-3.0.48.1/cnf/make.conf.example.loong.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.m68k.diff` & `portage-3.0.48.1/cnf/make.conf.example.m68k.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.mips.diff` & `portage-3.0.48.1/cnf/make.conf.example.mips.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.ppc.diff` & `portage-3.0.48.1/cnf/make.conf.example.ppc.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.ppc64.diff` & `portage-3.0.48.1/cnf/make.conf.example.ppc64.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.riscv.diff` & `portage-3.0.48.1/cnf/make.conf.example.riscv.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.s390.diff` & `portage-3.0.48.1/cnf/make.conf.example.s390.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.sh.diff` & `portage-3.0.48.1/cnf/make.conf.example.sh.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.sparc-fbsd.diff` & `portage-3.0.48.1/cnf/make.conf.example.sparc-fbsd.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.sparc.diff` & `portage-3.0.48.1/cnf/make.conf.example.sparc.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.x86-fbsd.diff` & `portage-3.0.48.1/cnf/make.conf.example.x86-fbsd.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/cnf/make.conf.example.x86.diff` & `portage-3.0.48.1/cnf/make.conf.example.x86.diff`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/api/Makefile` & `portage-3.0.48.1/doc/api/Makefile`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/api/conf.py` & `portage-3.0.48.1/doc/api/conf.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/config/bashrc.docbook` & `portage-3.0.48.1/doc/config/bashrc.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/config/sets.docbook` & `portage-3.0.48.1/doc/config/sets.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/dependency_resolution/decision_making.docbook` & `portage-3.0.48.1/doc/dependency_resolution/decision_making.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/dependency_resolution/package_modeling.docbook` & `portage-3.0.48.1/doc/dependency_resolution/package_modeling.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/dependency_resolution/task_scheduling.docbook` & `portage-3.0.48.1/doc/dependency_resolution/task_scheduling.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/eapi/1.docbook` & `portage-3.0.48.1/doc/package/ebuild/eapi/1.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/eapi/2.docbook` & `portage-3.0.48.1/doc/package/ebuild/eapi/2.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/eapi/3.docbook` & `portage-3.0.48.1/doc/package/ebuild/eapi/3.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/eapi/4-slot-abi.docbook` & `portage-3.0.48.1/doc/package/ebuild/eapi/4-slot-abi.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/eapi/4.docbook` & `portage-3.0.48.1/doc/package/ebuild/eapi/4.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/eapi/5.docbook` & `portage-3.0.48.1/doc/package/ebuild/eapi/5.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/helper_functions.docbook` & `portage-3.0.48.1/doc/package/ebuild/helper_functions.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/package/ebuild/phases.docbook` & `portage-3.0.48.1/doc/package/ebuild/phases.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/portage.docbook` & `portage-3.0.48.1/doc/portage.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/doc/qa.docbook` & `portage-3.0.48.1/doc/qa.docbook`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/AbstractDepPriority.py` & `portage-3.0.48.1/lib/_emerge/AbstractDepPriority.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/AbstractEbuildProcess.py` & `portage-3.0.48.1/lib/_emerge/AbstractEbuildProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/AbstractPollTask.py` & `portage-3.0.48.1/lib/_emerge/AbstractPollTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/AsynchronousLock.py` & `portage-3.0.48.1/lib/_emerge/AsynchronousLock.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/AsynchronousTask.py` & `portage-3.0.48.1/lib/_emerge/AsynchronousTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/Binpkg.py` & `portage-3.0.48.1/lib/_emerge/Binpkg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BinpkgEnvExtractor.py` & `portage-3.0.48.1/lib/_emerge/BinpkgEnvExtractor.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BinpkgExtractorAsync.py` & `portage-3.0.48.1/lib/_emerge/BinpkgExtractorAsync.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BinpkgFetcher.py` & `portage-3.0.48.1/lib/_emerge/BinpkgFetcher.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BinpkgPrefetcher.py` & `portage-3.0.48.1/lib/_emerge/BinpkgPrefetcher.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BinpkgVerifier.py` & `portage-3.0.48.1/lib/_emerge/BinpkgVerifier.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BlockerCache.py` & `portage-3.0.48.1/lib/_emerge/BlockerCache.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/BlockerDB.py` & `portage-3.0.48.1/lib/_emerge/BlockerDB.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/CompositeTask.py` & `portage-3.0.48.1/lib/_emerge/CompositeTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/DepPriority.py` & `portage-3.0.48.1/lib/_emerge/DepPriority.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/DepPriorityNormalRange.py` & `portage-3.0.48.1/lib/_emerge/DepPriorityNormalRange.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/DepPrioritySatisfiedRange.py` & `portage-3.0.48.1/lib/_emerge/DepPrioritySatisfiedRange.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/Dependency.py` & `portage-3.0.48.1/lib/_emerge/Dependency.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/DependencyArg.py` & `portage-3.0.48.1/lib/_emerge/DependencyArg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildBinpkg.py` & `portage-3.0.48.1/lib/_emerge/EbuildBinpkg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildBuild.py` & `portage-3.0.48.1/lib/_emerge/EbuildBuild.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildBuildDir.py` & `portage-3.0.48.1/lib/_emerge/EbuildBuildDir.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildExecuter.py` & `portage-3.0.48.1/lib/_emerge/EbuildExecuter.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildFetcher.py` & `portage-3.0.48.1/lib/_emerge/EbuildFetcher.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildFetchonly.py` & `portage-3.0.48.1/lib/_emerge/EbuildFetchonly.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildIpcDaemon.py` & `portage-3.0.48.1/lib/_emerge/EbuildIpcDaemon.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildMerge.py` & `portage-3.0.48.1/lib/_emerge/EbuildMerge.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildMetadataPhase.py` & `portage-3.0.48.1/lib/_emerge/EbuildMetadataPhase.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildPhase.py` & `portage-3.0.48.1/lib/_emerge/EbuildPhase.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildProcess.py` & `portage-3.0.48.1/lib/_emerge/EbuildProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/EbuildSpawnProcess.py` & `portage-3.0.48.1/lib/_emerge/EbuildSpawnProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/FakeVartree.py` & `portage-3.0.48.1/lib/_emerge/FakeVartree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/FifoIpcDaemon.py` & `portage-3.0.48.1/lib/_emerge/FifoIpcDaemon.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/JobStatusDisplay.py` & `portage-3.0.48.1/lib/_emerge/JobStatusDisplay.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/MergeListItem.py` & `portage-3.0.48.1/lib/_emerge/MergeListItem.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/MetadataRegen.py` & `portage-3.0.48.1/lib/_emerge/MetadataRegen.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/MiscFunctionsProcess.py` & `portage-3.0.48.1/lib/_emerge/MiscFunctionsProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/Package.py` & `portage-3.0.48.1/lib/_emerge/Package.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PackageArg.py` & `portage-3.0.48.1/lib/_emerge/PackageArg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PackageMerge.py` & `portage-3.0.48.1/lib/_emerge/PackageMerge.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PackagePhase.py` & `portage-3.0.48.1/lib/_emerge/PackagePhase.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PackageUninstall.py` & `portage-3.0.48.1/lib/_emerge/PackageUninstall.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PackageVirtualDbapi.py` & `portage-3.0.48.1/lib/_emerge/PackageVirtualDbapi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PipeReader.py` & `portage-3.0.48.1/lib/_emerge/PipeReader.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/PollScheduler.py` & `portage-3.0.48.1/lib/_emerge/PollScheduler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/ProgressHandler.py` & `portage-3.0.48.1/lib/_emerge/ProgressHandler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/RootConfig.py` & `portage-3.0.48.1/lib/_emerge/RootConfig.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/Scheduler.py` & `portage-3.0.48.1/lib/_emerge/Scheduler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/SequentialTaskQueue.py` & `portage-3.0.48.1/lib/_emerge/SequentialTaskQueue.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/SpawnProcess.py` & `portage-3.0.48.1/lib/_emerge/SpawnProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/SubProcess.py` & `portage-3.0.48.1/lib/_emerge/SubProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/Task.py` & `portage-3.0.48.1/lib/_emerge/Task.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/TaskSequence.py` & `portage-3.0.48.1/lib/_emerge/TaskSequence.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/UnmergeDepPriority.py` & `portage-3.0.48.1/lib/_emerge/UnmergeDepPriority.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/UseFlagDisplay.py` & `portage-3.0.48.1/lib/_emerge/UseFlagDisplay.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/UserQuery.py` & `portage-3.0.48.1/lib/_emerge/UserQuery.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/_find_deep_system_runtime_deps.py` & `portage-3.0.48.1/lib/_emerge/_find_deep_system_runtime_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/actions.py` & `portage-3.0.48.1/lib/_emerge/actions.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/chk_updated_cfg_files.py` & `portage-3.0.48.1/lib/_emerge/chk_updated_cfg_files.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/countdown.py` & `portage-3.0.48.1/lib/_emerge/countdown.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/create_depgraph_params.py` & `portage-3.0.48.1/lib/_emerge/create_depgraph_params.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/create_world_atom.py` & `portage-3.0.48.1/lib/_emerge/create_world_atom.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/depgraph.py` & `portage-3.0.48.1/lib/_emerge/depgraph.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/emergelog.py` & `portage-3.0.48.1/lib/_emerge/emergelog.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/getloadavg.py` & `portage-3.0.48.1/lib/_emerge/getloadavg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/help.py` & `portage-3.0.48.1/lib/_emerge/help.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/is_valid_package_atom.py` & `portage-3.0.48.1/lib/_emerge/is_valid_package_atom.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/main.py` & `portage-3.0.48.1/lib/_emerge/main.py`
...
### Comparing `portage-3.0.48/lib/_emerge/post_emerge.py` & `portage-3.0.48.1/lib/_emerge/post_emerge.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/DbapiProvidesIndex.py` & `portage-3.0.48.1/lib/_emerge/resolver/DbapiProvidesIndex.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/backtracking.py` & `portage-3.0.48.1/lib/_emerge/resolver/backtracking.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/circular_dependency.py` & `portage-3.0.48.1/lib/_emerge/resolver/circular_dependency.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/output.py` & `portage-3.0.48.1/lib/_emerge/resolver/output.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/output_helpers.py` & `portage-3.0.48.1/lib/_emerge/resolver/output_helpers.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/package_tracker.py` & `portage-3.0.48.1/lib/_emerge/resolver/package_tracker.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/resolver/slot_collision.py` & `portage-3.0.48.1/lib/_emerge/resolver/slot_collision.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/search.py` & `portage-3.0.48.1/lib/_emerge/search.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/show_invalid_depstring_notice.py` & `portage-3.0.48.1/lib/_emerge/show_invalid_depstring_notice.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/stdout_spinner.py` & `portage-3.0.48.1/lib/_emerge/stdout_spinner.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/_emerge/unmerge.py` & `portage-3.0.48.1/lib/_emerge/unmerge.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/__init__.py` & `portage-3.0.48.1/lib/portage/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_compat_upgrade/binpkg_compression.py` & `portage-3.0.48.1/lib/portage/_compat_upgrade/binpkg_compression.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_compat_upgrade/binpkg_multi_instance.py` & `portage-3.0.48.1/lib/portage/_compat_upgrade/binpkg_multi_instance.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_compat_upgrade/default_locations.py` & `portage-3.0.48.1/lib/portage/_compat_upgrade/default_locations.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/Config.py` & `portage-3.0.48.1/lib/portage/_emirrordist/Config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/ContentDB.py` & `portage-3.0.48.1/lib/portage/_emirrordist/ContentDB.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/DeletionIterator.py` & `portage-3.0.48.1/lib/portage/_emirrordist/DeletionIterator.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/DeletionTask.py` & `portage-3.0.48.1/lib/portage/_emirrordist/DeletionTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/FetchIterator.py` & `portage-3.0.48.1/lib/portage/_emirrordist/FetchIterator.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/FetchTask.py` & `portage-3.0.48.1/lib/portage/_emirrordist/FetchTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/MirrorDistTask.py` & `portage-3.0.48.1/lib/portage/_emirrordist/MirrorDistTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_emirrordist/main.py` & `portage-3.0.48.1/lib/portage/_emirrordist/main.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_global_updates.py` & `portage-3.0.48.1/lib/portage/_global_updates.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_legacy_globals.py` & `portage-3.0.48.1/lib/portage/_legacy_globals.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_selinux.py` & `portage-3.0.48.1/lib/portage/_selinux.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/ProfilePackageSet.py` & `portage-3.0.48.1/lib/portage/_sets/ProfilePackageSet.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/__init__.py` & `portage-3.0.48.1/lib/portage/_sets/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/base.py` & `portage-3.0.48.1/lib/portage/_sets/base.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/dbapi.py` & `portage-3.0.48.1/lib/portage/_sets/dbapi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/files.py` & `portage-3.0.48.1/lib/portage/_sets/files.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/libs.py` & `portage-3.0.48.1/lib/portage/_sets/libs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/profiles.py` & `portage-3.0.48.1/lib/portage/_sets/profiles.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/security.py` & `portage-3.0.48.1/lib/portage/_sets/security.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/_sets/shell.py` & `portage-3.0.48.1/lib/portage/_sets/shell.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/binpkg.py` & `portage-3.0.48.1/lib/portage/binpkg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/binrepo/config.py` & `portage-3.0.48.1/lib/portage/binrepo/config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/anydbm.py` & `portage-3.0.48.1/lib/portage/cache/anydbm.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/cache_errors.py` & `portage-3.0.48.1/lib/portage/cache/cache_errors.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/ebuild_xattr.py` & `portage-3.0.48.1/lib/portage/cache/ebuild_xattr.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/flat_hash.py` & `portage-3.0.48.1/lib/portage/cache/flat_hash.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/fs_template.py` & `portage-3.0.48.1/lib/portage/cache/fs_template.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/index/IndexStreamIterator.py` & `portage-3.0.48.1/lib/portage/cache/index/IndexStreamIterator.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/index/pkg_desc_index.py` & `portage-3.0.48.1/lib/portage/cache/index/pkg_desc_index.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/mappings.py` & `portage-3.0.48.1/lib/portage/cache/mappings.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/metadata.py` & `portage-3.0.48.1/lib/portage/cache/metadata.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/sql_template.py` & `portage-3.0.48.1/lib/portage/cache/sql_template.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/sqlite.py` & `portage-3.0.48.1/lib/portage/cache/sqlite.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/template.py` & `portage-3.0.48.1/lib/portage/cache/template.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cache/volatile.py` & `portage-3.0.48.1/lib/portage/cache/volatile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/checksum.py` & `portage-3.0.48.1/lib/portage/checksum.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/const.py` & `portage-3.0.48.1/lib/portage/const.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/cvstree.py` & `portage-3.0.48.1/lib/portage/cvstree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/data.py` & `portage-3.0.48.1/lib/portage/data.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/DummyTree.py` & `portage-3.0.48.1/lib/portage/dbapi/DummyTree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/IndexedPortdb.py` & `portage-3.0.48.1/lib/portage/dbapi/IndexedPortdb.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/IndexedVardb.py` & `portage-3.0.48.1/lib/portage/dbapi/IndexedVardb.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/_ContentsCaseSensitivityManager.py` & `portage-3.0.48.1/lib/portage/dbapi/_ContentsCaseSensitivityManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/_MergeProcess.py` & `portage-3.0.48.1/lib/portage/dbapi/_MergeProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/_SyncfsProcess.py` & `portage-3.0.48.1/lib/portage/dbapi/_SyncfsProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/_VdbMetadataDelta.py` & `portage-3.0.48.1/lib/portage/dbapi/_VdbMetadataDelta.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/__init__.py` & `portage-3.0.48.1/lib/portage/dbapi/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/_expand_new_virt.py` & `portage-3.0.48.1/lib/portage/dbapi/_expand_new_virt.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/_similar_name_search.py` & `portage-3.0.48.1/lib/portage/dbapi/_similar_name_search.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/bintree.py` & `portage-3.0.48.1/lib/portage/dbapi/bintree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/cpv_expand.py` & `portage-3.0.48.1/lib/portage/dbapi/cpv_expand.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/dep_expand.py` & `portage-3.0.48.1/lib/portage/dbapi/dep_expand.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/porttree.py` & `portage-3.0.48.1/lib/portage/dbapi/porttree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/vartree.py` & `portage-3.0.48.1/lib/portage/dbapi/vartree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dbapi/virtual.py` & `portage-3.0.48.1/lib/portage/dbapi/virtual.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/debug.py` & `portage-3.0.48.1/lib/portage/debug.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/__init__.py` & `portage-3.0.48.1/lib/portage/dep/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/_dnf.py` & `portage-3.0.48.1/lib/portage/dep/_dnf.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/_slot_operator.py` & `portage-3.0.48.1/lib/portage/dep/_slot_operator.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/dep_check.py` & `portage-3.0.48.1/lib/portage/dep/dep_check.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/soname/SonameAtom.py` & `portage-3.0.48.1/lib/portage/dep/soname/SonameAtom.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/soname/multilib_category.py` & `portage-3.0.48.1/lib/portage/dep/soname/multilib_category.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dep/soname/parse.py` & `portage-3.0.48.1/lib/portage/dep/soname/parse.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/dispatch_conf.py` & `portage-3.0.48.1/lib/portage/dispatch_conf.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/eapi.py` & `portage-3.0.48.1/lib/portage/eapi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/eclass_cache.py` & `portage-3.0.48.1/lib/portage/eclass_cache.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/__init__.py` & `portage-3.0.48.1/lib/portage/elog/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/filtering.py` & `portage-3.0.48.1/lib/portage/elog/filtering.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/messages.py` & `portage-3.0.48.1/lib/portage/elog/messages.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_custom.py` & `portage-3.0.48.1/lib/portage/elog/mod_custom.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_echo.py` & `portage-3.0.48.1/lib/portage/elog/mod_echo.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_mail.py` & `portage-3.0.48.1/lib/portage/elog/mod_mail.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_mail_summary.py` & `portage-3.0.48.1/lib/portage/elog/mod_mail_summary.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_save.py` & `portage-3.0.48.1/lib/portage/elog/mod_save.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_save_summary.py` & `portage-3.0.48.1/lib/portage/elog/mod_save_summary.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/elog/mod_syslog.py` & `portage-3.0.48.1/lib/portage/elog/mod_syslog.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/defaults.py` & `portage-3.0.48.1/lib/portage/emaint/defaults.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/main.py` & `portage-3.0.48.1/lib/portage/emaint/main.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/binhost/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/binhost/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/binhost/binhost.py` & `portage-3.0.48.1/lib/portage/emaint/modules/binhost/binhost.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/config/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/config/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/config/config.py` & `portage-3.0.48.1/lib/portage/emaint/modules/config/config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/logs/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/logs/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/logs/logs.py` & `portage-3.0.48.1/lib/portage/emaint/modules/logs/logs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/merges/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/merges/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/merges/merges.py` & `portage-3.0.48.1/lib/portage/emaint/modules/merges/merges.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/move/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/move/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/move/move.py` & `portage-3.0.48.1/lib/portage/emaint/modules/move/move.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/resume/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/resume/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/resume/resume.py` & `portage-3.0.48.1/lib/portage/emaint/modules/resume/resume.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/sync/__init__.py` & `portage-3.0.48.1/lib/portage/emaint/modules/sync/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/sync/sync.py` & `portage-3.0.48.1/lib/portage/emaint/modules/sync/sync.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/emaint/modules/world/world.py` & `portage-3.0.48.1/lib/portage/emaint/modules/world/world.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/env/config.py` & `portage-3.0.48.1/lib/portage/env/config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/env/loaders.py` & `portage-3.0.48.1/lib/portage/env/loaders.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/env/validators.py` & `portage-3.0.48.1/lib/portage/env/validators.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/exception.py` & `portage-3.0.48.1/lib/portage/exception.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/getbinpkg.py` & `portage-3.0.48.1/lib/portage/getbinpkg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/glsa.py` & `portage-3.0.48.1/lib/portage/glsa.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/gpg.py` & `portage-3.0.48.1/lib/portage/gpg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/gpkg.py` & `portage-3.0.48.1/lib/portage/gpkg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/localization.py` & `portage-3.0.48.1/lib/portage/localization.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/locks.py` & `portage-3.0.48.1/lib/portage/locks.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/mail.py` & `portage-3.0.48.1/lib/portage/mail.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/manifest.py` & `portage-3.0.48.1/lib/portage/manifest.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/metadata.py` & `portage-3.0.48.1/lib/portage/metadata.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/module.py` & `portage-3.0.48.1/lib/portage/module.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/news.py` & `portage-3.0.48.1/lib/portage/news.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/output.py` & `portage-3.0.48.1/lib/portage/output.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/KeywordsManager.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/KeywordsManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/LicenseManager.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/LicenseManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/LocationsManager.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/LocationsManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/MaskManager.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/MaskManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/UseManager.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/UseManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/VirtualsManager.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/VirtualsManager.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/env_var_validation.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/env_var_validation.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/features_set.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/features_set.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/helper.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/helper.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_config/special_env_vars.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_config/special_env_vars.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_ipc/ExitCommand.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_ipc/ExitCommand.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_ipc/QueryCommand.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_ipc/QueryCommand.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_metadata_invalid.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_metadata_invalid.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_parallel_manifest/ManifestProcess.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_parallel_manifest/ManifestProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_parallel_manifest/ManifestScheduler.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_parallel_manifest/ManifestScheduler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_parallel_manifest/ManifestTask.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_parallel_manifest/ManifestTask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/_spawn_nofetch.py` & `portage-3.0.48.1/lib/portage/package/ebuild/_spawn_nofetch.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/config.py` & `portage-3.0.48.1/lib/portage/package/ebuild/config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/deprecated_profile_check.py` & `portage-3.0.48.1/lib/portage/package/ebuild/deprecated_profile_check.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/digestcheck.py` & `portage-3.0.48.1/lib/portage/package/ebuild/digestcheck.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/digestgen.py` & `portage-3.0.48.1/lib/portage/package/ebuild/digestgen.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/doebuild.py` & `portage-3.0.48.1/lib/portage/package/ebuild/doebuild.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/fetch.py` & `portage-3.0.48.1/lib/portage/package/ebuild/fetch.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/getmaskingreason.py` & `portage-3.0.48.1/lib/portage/package/ebuild/getmaskingreason.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/getmaskingstatus.py` & `portage-3.0.48.1/lib/portage/package/ebuild/getmaskingstatus.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/prepare_build_dirs.py` & `portage-3.0.48.1/lib/portage/package/ebuild/prepare_build_dirs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/package/ebuild/profile_iuse.py` & `portage-3.0.48.1/lib/portage/package/ebuild/profile_iuse.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/process.py` & `portage-3.0.48.1/lib/portage/process.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/progress.py` & `portage-3.0.48.1/lib/portage/progress.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/proxy/lazyimport.py` & `portage-3.0.48.1/lib/portage/proxy/lazyimport.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/proxy/objectproxy.py` & `portage-3.0.48.1/lib/portage/proxy/objectproxy.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/repository/config.py` & `portage-3.0.48.1/lib/portage/repository/config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/repository/storage/hardlink_quarantine.py` & `portage-3.0.48.1/lib/portage/repository/storage/hardlink_quarantine.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/repository/storage/hardlink_rcu.py` & `portage-3.0.48.1/lib/portage/repository/storage/hardlink_rcu.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/repository/storage/inplace.py` & `portage-3.0.48.1/lib/portage/repository/storage/inplace.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/repository/storage/interface.py` & `portage-3.0.48.1/lib/portage/repository/storage/interface.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/__init__.py` & `portage-3.0.48.1/lib/portage/sync/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/config_checks.py` & `portage-3.0.48.1/lib/portage/sync/config_checks.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/controller.py` & `portage-3.0.48.1/lib/portage/sync/controller.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/getaddrinfo_validate.py` & `portage-3.0.48.1/lib/portage/sync/getaddrinfo_validate.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/cvs/__init__.py` & `portage-3.0.48.1/lib/portage/sync/modules/cvs/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/cvs/cvs.py` & `portage-3.0.48.1/lib/portage/sync/modules/cvs/cvs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/git/__init__.py` & `portage-3.0.48.1/lib/portage/sync/modules/git/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/git/git.py` & `portage-3.0.48.1/lib/portage/sync/modules/git/git.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/mercurial/__init__.py` & `portage-3.0.48.1/lib/portage/sync/modules/mercurial/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/mercurial/mercurial.py` & `portage-3.0.48.1/lib/portage/sync/modules/mercurial/mercurial.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/rsync/__init__.py` & `portage-3.0.48.1/lib/portage/sync/modules/rsync/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/rsync/rsync.py` & `portage-3.0.48.1/lib/portage/sync/modules/rsync/rsync.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/svn/__init__.py` & `portage-3.0.48.1/lib/portage/sync/modules/svn/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/svn/svn.py` & `portage-3.0.48.1/lib/portage/sync/modules/svn/svn.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/webrsync/__init__.py` & `portage-3.0.48.1/lib/portage/sync/modules/webrsync/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/modules/webrsync/webrsync.py` & `portage-3.0.48.1/lib/portage/sync/modules/webrsync/webrsync.py`
...
### Comparing `portage-3.0.48/lib/portage/sync/old_tree_timestamp.py` & `portage-3.0.48.1/lib/portage/sync/old_tree_timestamp.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/sync/syncbase.py` & `portage-3.0.48.1/lib/portage/sync/syncbase.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/.gnupg/openpgp-revocs.d/06B3A311BD775C280D22A9305D90EA06352177F6.rev` & `portage-3.0.48.1/lib/portage/tests/.gnupg/openpgp-revocs.d/06B3A311BD775C280D22A9305D90EA06352177F6.rev`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/.gnupg/openpgp-revocs.d/8DEDA2CDED49C8809287B89D8812797DDF1DD192.rev` & `portage-3.0.48.1/lib/portage/tests/.gnupg/openpgp-revocs.d/8DEDA2CDED49C8809287B89D8812797DDF1DD192.rev`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/.gnupg/private-keys-v1.d/273B030399E7BEA66A9AD42216DE7CA17BA5D42E.key` & `portage-3.0.48.1/lib/portage/tests/.gnupg/private-keys-v1.d/273B030399E7BEA66A9AD42216DE7CA17BA5D42E.key`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/.gnupg/private-keys-v1.d/C99796FB85B0C3DF03314A11B5850C51167D6282.key` & `portage-3.0.48.1/lib/portage/tests/.gnupg/private-keys-v1.d/C99796FB85B0C3DF03314A11B5850C51167D6282.key`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/.gnupg/pubring.kbx` & `portage-3.0.48.1/lib/portage/tests/.gnupg/pubring.kbx`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/.gnupg/trustdb.gpg` & `portage-3.0.48.1/lib/portage/tests/.gnupg/trustdb.gpg`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/__init__.py` & `portage-3.0.48.1/lib/portage/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/bin/setup_env.py` & `portage-3.0.48.1/lib/portage/tests/bin/setup_env.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/bin/test_dobin.py` & `portage-3.0.48.1/lib/portage/tests/bin/test_dobin.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/bin/test_dodir.py` & `portage-3.0.48.1/lib/portage/tests/bin/test_dodir.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/bin/test_doins.py` & `portage-3.0.48.1/lib/portage/tests/bin/test_doins.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/bin/test_eapi7_ver_funcs.py` & `portage-3.0.48.1/lib/portage/tests/bin/test_eapi7_ver_funcs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/bin/test_filter_bash_env.py` & `portage-3.0.48.1/lib/portage/tests/bin/test_filter_bash_env.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/conftest.py` & `portage-3.0.48.1/lib/portage/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dbapi/test_auxdb.py` & `portage-3.0.48.1/lib/portage/tests/dbapi/test_auxdb.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dbapi/test_bintree.py` & `portage-3.0.48.1/lib/portage/tests/dbapi/test_bintree.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dbapi/test_fakedbapi.py` & `portage-3.0.48.1/lib/portage/tests/dbapi/test_fakedbapi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dbapi/test_portdb_cache.py` & `portage-3.0.48.1/lib/portage/tests/dbapi/test_portdb_cache.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/testAtom.py` & `portage-3.0.48.1/lib/portage/tests/dep/testAtom.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/testCheckRequiredUse.py` & `portage-3.0.48.1/lib/portage/tests/dep/testCheckRequiredUse.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/testExtendedAtomDict.py` & `portage-3.0.48.1/lib/portage/tests/dep/testExtendedAtomDict.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/testExtractAffectingUSE.py` & `portage-3.0.48.1/lib/portage/tests/dep/testExtractAffectingUSE.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/testStandalone.py` & `portage-3.0.48.1/lib/portage/tests/dep/testStandalone.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_best_match_to_list.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_best_match_to_list.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_dep_getcpv.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_dep_getcpv.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_dep_getrepo.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_dep_getrepo.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_dep_getslot.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_dep_getslot.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_dep_getusedeps.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_dep_getusedeps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_dnf_convert.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_dnf_convert.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_get_operator.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_get_operator.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_get_required_use_flags.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_get_required_use_flags.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_isjustname.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_isjustname.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_isvalidatom.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_isvalidatom.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_match_from_list.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_match_from_list.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_overlap_dnf.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_overlap_dnf.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_paren_reduce.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_paren_reduce.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_soname_atom_pickle.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_soname_atom_pickle.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/dep/test_use_reduce.py` & `portage-3.0.48.1/lib/portage/tests/dep/test_use_reduce.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_array_fromfile_eof.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_array_fromfile_eof.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_config.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_config.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_doebuild_fd_pipes.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_doebuild_fd_pipes.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_doebuild_spawn.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_doebuild_spawn.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_fetch.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_fetch.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_ipc_daemon.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_ipc_daemon.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_shell_quote.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_shell_quote.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_spawn.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_spawn.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/ebuild/test_use_expand_incremental.py` & `portage-3.0.48.1/lib/portage/tests/ebuild/test_use_expand_incremental.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/emerge/test_actions.py` & `portage-3.0.48.1/lib/portage/tests/emerge/test_actions.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/emerge/test_config_protect.py` & `portage-3.0.48.1/lib/portage/tests/emerge/test_config_protect.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/emerge/test_emerge_blocker_file_collision.py` & `portage-3.0.48.1/lib/portage/tests/emerge/test_emerge_blocker_file_collision.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/emerge/test_emerge_slot_abi.py` & `portage-3.0.48.1/lib/portage/tests/emerge/test_emerge_slot_abi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/emerge/test_global_updates.py` & `portage-3.0.48.1/lib/portage/tests/emerge/test_global_updates.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/emerge/test_simple.py` & `portage-3.0.48.1/lib/portage/tests/emerge/test_simple.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/env/config/test_PackageKeywordsFile.py` & `portage-3.0.48.1/lib/portage/tests/env/config/test_PackageKeywordsFile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/env/config/test_PackageMaskFile.py` & `portage-3.0.48.1/lib/portage/tests/env/config/test_PackageMaskFile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/env/config/test_PackageUseFile.py` & `portage-3.0.48.1/lib/portage/tests/env/config/test_PackageUseFile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/env/config/test_PortageModulesFile.py` & `portage-3.0.48.1/lib/portage/tests/env/config/test_PortageModulesFile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/glsa/test_security_set.py` & `portage-3.0.48.1/lib/portage/tests/glsa/test_security_set.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_checksum.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_checksum.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_gpg.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_gpg.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_metadata_update.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_metadata_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_metadata_url.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_metadata_url.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_path.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_path.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_size.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_size.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/gpkg/test_gpkg_stream.py` & `portage-3.0.48.1/lib/portage/tests/gpkg/test_gpkg_stream.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/lafilefixer/test_lafilefixer.py` & `portage-3.0.48.1/lib/portage/tests/lafilefixer/test_lafilefixer.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/lazyimport/test_lazy_import_portage_baseline.py` & `portage-3.0.48.1/lib/portage/tests/lazyimport/test_lazy_import_portage_baseline.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/lazyimport/test_preload_portage_submodules.py` & `portage-3.0.48.1/lib/portage/tests/lazyimport/test_preload_portage_submodules.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/lint/test_bash_syntax.py` & `portage-3.0.48.1/lib/portage/tests/lint/test_bash_syntax.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/lint/test_compile_modules.py` & `portage-3.0.48.1/lib/portage/tests/lint/test_compile_modules.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/lint/test_import_modules.py` & `portage-3.0.48.1/lib/portage/tests/lint/test_import_modules.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/locks/test_asynchronous_lock.py` & `portage-3.0.48.1/lib/portage/tests/locks/test_asynchronous_lock.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/locks/test_lock_nonblock.py` & `portage-3.0.48.1/lib/portage/tests/locks/test_lock_nonblock.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/news/test_NewsItem.py` & `portage-3.0.48.1/lib/portage/tests/news/test_NewsItem.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_AsyncFunction.py` & `portage-3.0.48.1/lib/portage/tests/process/test_AsyncFunction.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_PipeLogger.py` & `portage-3.0.48.1/lib/portage/tests/process/test_PipeLogger.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_PopenProcess.py` & `portage-3.0.48.1/lib/portage/tests/process/test_PopenProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_PopenProcessBlockingIO.py` & `portage-3.0.48.1/lib/portage/tests/process/test_PopenProcessBlockingIO.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_poll.py` & `portage-3.0.48.1/lib/portage/tests/process/test_poll.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_spawn_fail_e2big.py` & `portage-3.0.48.1/lib/portage/tests/process/test_spawn_fail_e2big.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_spawn_warn_large_env.py` & `portage-3.0.48.1/lib/portage/tests/process/test_spawn_warn_large_env.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/process/test_unshare_net.py` & `portage-3.0.48.1/lib/portage/tests/process/test_unshare_net.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/ResolverPlayground.py` & `portage-3.0.48.1/lib/portage/tests/resolver/ResolverPlayground.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/binpkg_multi_instance/test_build_id_profile_format.py` & `portage-3.0.48.1/lib/portage/tests/resolver/binpkg_multi_instance/test_build_id_profile_format.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/binpkg_multi_instance/test_rebuilt_binaries.py` & `portage-3.0.48.1/lib/portage/tests/resolver/binpkg_multi_instance/test_rebuilt_binaries.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_autounmask.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_autounmask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_depclean.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_depclean.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_downgrade.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_downgrade.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_or_choices.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_or_choices.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_reinstall.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_reinstall.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_skip_update.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_skip_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_slot_conflict_reinstall.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_slot_conflict_reinstall.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_slot_conflict_update.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_slot_conflict_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_soname_provided.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_soname_provided.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_unsatisfiable.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_unsatisfiable.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/soname/test_unsatisfied.py` & `portage-3.0.48.1/lib/portage/tests/resolver/soname/test_unsatisfied.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_aggressive_backtrack_downgrade.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_aggressive_backtrack_downgrade.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_binpkg_use.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_binpkg_use.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_keep_keywords.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_keep_keywords.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_multilib_use.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_multilib_use.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_parent.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_parent.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_use_backtrack.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_use_backtrack.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_use_breakage.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_use_breakage.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_autounmask_use_slot_conflict.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_autounmask_use_slot_conflict.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_backtracking.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_backtracking.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_bdeps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_bdeps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_binary_pkg_ebuild_visibility.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_binary_pkg_ebuild_visibility.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_blocker.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_blocker.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_changed_deps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_changed_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_circular_choices.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_circular_choices.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_circular_choices_rust.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_circular_choices_rust.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_circular_dependencies.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_circular_dependencies.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_complete_graph.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_complete_graph.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_complete_if_new_subslot_without_revbump.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_complete_if_new_subslot_without_revbump.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_depclean.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_depclean.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_depclean_order.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_depclean_order.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_depclean_slot_unavailable.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_depclean_slot_unavailable.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_depth.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_depth.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_disjunctive_depend_order.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_disjunctive_depend_order.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_eapi.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_eapi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_features_test_use.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_features_test_use.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_imagemagick_graphicsmagick.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_imagemagick_graphicsmagick.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_installkernel.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_installkernel.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_keywords.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_keywords.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_merge_order.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_merge_order.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_missing_iuse_and_evaluated_atoms.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_missing_iuse_and_evaluated_atoms.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_multirepo.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_multirepo.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_multislot.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_multislot.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_old_dep_chain_display.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_old_dep_chain_display.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_onlydeps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_onlydeps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_onlydeps_circular.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_onlydeps_circular.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_onlydeps_ideps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_onlydeps_ideps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_onlydeps_minimal.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_onlydeps_minimal.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_or_choices.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_or_choices.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_or_downgrade_installed.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_or_downgrade_installed.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_or_upgrade_installed.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_or_upgrade_installed.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_output.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_output.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_package_tracker.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_package_tracker.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_profile_default_eapi.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_profile_default_eapi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_profile_package_set.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_profile_package_set.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_rebuild.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_rebuild.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_regular_slot_change_without_revbump.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_regular_slot_change_without_revbump.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_required_use.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_required_use.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_runtime_cycle_merge_order.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_runtime_cycle_merge_order.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_simple.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_simple.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_abi.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_abi.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_abi_downgrade.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_abi_downgrade.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_change_without_revbump.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_change_without_revbump.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_collisions.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_collisions.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_conflict_force_rebuild.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_conflict_force_rebuild.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_conflict_mask_update.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_conflict_mask_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_conflict_rebuild.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_conflict_rebuild.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_conflict_unsatisfied_deep_deps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_conflict_unsatisfied_deep_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_conflict_update.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_conflict_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_conflict_update_virt.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_conflict_update_virt.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_autounmask.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_autounmask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_bdeps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_bdeps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_complete_graph.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_complete_graph.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_exclusive_slots.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_exclusive_slots.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_missed_update.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_missed_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_rebuild.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_rebuild.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_required_use.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_required_use.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_reverse_deps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_reverse_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_runtime_pkg_mask.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_runtime_pkg_mask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_unsatisfied.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_unsatisfied.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_unsolved.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_unsolved.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_slot_operator_update_probe_parent_downgrade.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_slot_operator_update_probe_parent_downgrade.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_solve_non_slot_operator_slot_conflicts.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_solve_non_slot_operator_slot_conflicts.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_targetroot.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_targetroot.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_unecessary_slot_upgrade.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_unecessary_slot_upgrade.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_unmerge_order.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_unmerge_order.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_update.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_use_dep_defaults.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_use_dep_defaults.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_useflags.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_useflags.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_virtual_minimize_children.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_virtual_minimize_children.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_virtual_slot.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_virtual_slot.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/resolver/test_with_test_deps.py` & `portage-3.0.48.1/lib/portage/tests/resolver/test_with_test_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/runTests.py` & `portage-3.0.48.1/lib/portage/tests/runTests.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/sets/base/testInternalPackageSet.py` & `portage-3.0.48.1/lib/portage/tests/sets/base/testInternalPackageSet.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/sets/base/testVariableSet.py` & `portage-3.0.48.1/lib/portage/tests/sets/base/testVariableSet.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/sets/files/testConfigFileSet.py` & `portage-3.0.48.1/lib/portage/tests/sets/files/testConfigFileSet.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/sets/files/testStaticFileSet.py` & `portage-3.0.48.1/lib/portage/tests/sets/files/testStaticFileSet.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/sets/shell/testShell.py` & `portage-3.0.48.1/lib/portage/tests/sets/shell/testShell.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/sync/test_sync_local.py` & `portage-3.0.48.1/lib/portage/tests/sync/test_sync_local.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/unicode/test_string_format.py` & `portage-3.0.48.1/lib/portage/tests/unicode/test_string_format.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/update/test_move_ent.py` & `portage-3.0.48.1/lib/portage/tests/update/test_move_ent.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/update/test_move_slot_ent.py` & `portage-3.0.48.1/lib/portage/tests/update/test_move_slot_ent.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/update/test_update_dbentry.py` & `portage-3.0.48.1/lib/portage/tests/update/test_update_dbentry.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/dyn_libs/test_soname_deps.py` & `portage-3.0.48.1/lib/portage/tests/util/dyn_libs/test_soname_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/eventloop/test_call_soon_fifo.py` & `portage-3.0.48.1/lib/portage/tests/util/eventloop/test_call_soon_fifo.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/file_copy/test_copyfile.py` & `portage-3.0.48.1/lib/portage/tests/util/file_copy/test_copyfile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_child_watcher.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_child_watcher.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_event_loop_in_fork.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_event_loop_in_fork.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_pipe_closed.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_pipe_closed.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_policy_wrapper_recursion.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_policy_wrapper_recursion.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_run_until_complete.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_run_until_complete.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_subprocess_exec.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_subprocess_exec.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/asyncio/test_wakeup_fd_sigchld.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/asyncio/test_wakeup_fd_sigchld.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/test_compat_coroutine.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/test_compat_coroutine.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/test_done_callback.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/test_done_callback.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/test_done_callback_after_exit.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/test_done_callback_after_exit.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/test_iter_completed.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/test_iter_completed.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/futures/test_retry.py` & `portage-3.0.48.1/lib/portage/tests/util/futures/test_retry.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_checksum.py` & `portage-3.0.48.1/lib/portage/tests/util/test_checksum.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_digraph.py` & `portage-3.0.48.1/lib/portage/tests/util/test_digraph.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_file_copier.py` & `portage-3.0.48.1/lib/portage/tests/util/test_file_copier.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_getconfig.py` & `portage-3.0.48.1/lib/portage/tests/util/test_getconfig.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_install_mask.py` & `portage-3.0.48.1/lib/portage/tests/util/test_install_mask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_manifest.py` & `portage-3.0.48.1/lib/portage/tests/util/test_manifest.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_mtimedb.py` & `portage-3.0.48.1/lib/portage/tests/util/test_mtimedb.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_shelve.py` & `portage-3.0.48.1/lib/portage/tests/util/test_shelve.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_socks5.py` & `portage-3.0.48.1/lib/portage/tests/util/test_socks5.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_stackDictList.py` & `portage-3.0.48.1/lib/portage/tests/util/test_stackDictList.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_stackDicts.py` & `portage-3.0.48.1/lib/portage/tests/util/test_stackDicts.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_stackLists.py` & `portage-3.0.48.1/lib/portage/tests/util/test_stackLists.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_uniqueArray.py` & `portage-3.0.48.1/lib/portage/tests/util/test_uniqueArray.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_varExpand.py` & `portage-3.0.48.1/lib/portage/tests/util/test_varExpand.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_whirlpool.py` & `portage-3.0.48.1/lib/portage/tests/util/test_whirlpool.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/util/test_xattr.py` & `portage-3.0.48.1/lib/portage/tests/util/test_xattr.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/versions/test_cpv_sort_key.py` & `portage-3.0.48.1/lib/portage/tests/versions/test_cpv_sort_key.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/tests/versions/test_vercmp.py` & `portage-3.0.48.1/lib/portage/tests/versions/test_vercmp.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/update.py` & `portage-3.0.48.1/lib/portage/update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/ExtractKernelVersion.py` & `portage-3.0.48.1/lib/portage/util/ExtractKernelVersion.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/SlotObject.py` & `portage-3.0.48.1/lib/portage/util/SlotObject.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/__init__.py` & `portage-3.0.48.1/lib/portage/util/__init__.py`
...
### Comparing `portage-3.0.48/lib/portage/util/_async/AsyncFunction.py` & `portage-3.0.48.1/lib/portage/util/_async/AsyncFunction.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/AsyncScheduler.py` & `portage-3.0.48.1/lib/portage/util/_async/AsyncScheduler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/AsyncTaskFuture.py` & `portage-3.0.48.1/lib/portage/util/_async/AsyncTaskFuture.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/BuildLogger.py` & `portage-3.0.48.1/lib/portage/util/_async/BuildLogger.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/FileCopier.py` & `portage-3.0.48.1/lib/portage/util/_async/FileCopier.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/FileDigester.py` & `portage-3.0.48.1/lib/portage/util/_async/FileDigester.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/ForkProcess.py` & `portage-3.0.48.1/lib/portage/util/_async/ForkProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/PipeLogger.py` & `portage-3.0.48.1/lib/portage/util/_async/PipeLogger.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/PipeReaderBlockingIO.py` & `portage-3.0.48.1/lib/portage/util/_async/PipeReaderBlockingIO.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/PopenProcess.py` & `portage-3.0.48.1/lib/portage/util/_async/PopenProcess.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/SchedulerInterface.py` & `portage-3.0.48.1/lib/portage/util/_async/SchedulerInterface.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/TaskScheduler.py` & `portage-3.0.48.1/lib/portage/util/_async/TaskScheduler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_async/run_main_scheduler.py` & `portage-3.0.48.1/lib/portage/util/_async/run_main_scheduler.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_compare_files.py` & `portage-3.0.48.1/lib/portage/util/_compare_files.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_ctypes.py` & `portage-3.0.48.1/lib/portage/util/_ctypes.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_desktop_entry.py` & `portage-3.0.48.1/lib/portage/util/_desktop_entry.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/LinkageMapELF.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/LinkageMapELF.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/NeededEntry.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/NeededEntry.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/PreservedLibsRegistry.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/PreservedLibsRegistry.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/display_preserved_libs.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/display_preserved_libs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/dyn_libs.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/dyn_libs.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/soname_deps.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/soname_deps.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_dyn_libs/soname_deps_qa.py` & `portage-3.0.48.1/lib/portage/util/_dyn_libs/soname_deps_qa.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_eventloop/asyncio_event_loop.py` & `portage-3.0.48.1/lib/portage/util/_eventloop/asyncio_event_loop.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_get_vm_info.py` & `portage-3.0.48.1/lib/portage/util/_get_vm_info.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_info_files.py` & `portage-3.0.48.1/lib/portage/util/_info_files.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_path.py` & `portage-3.0.48.1/lib/portage/util/_path.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_pty.py` & `portage-3.0.48.1/lib/portage/util/_pty.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_urlopen.py` & `portage-3.0.48.1/lib/portage/util/_urlopen.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/_xattr.py` & `portage-3.0.48.1/lib/portage/util/_xattr.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/backoff.py` & `portage-3.0.48.1/lib/portage/util/backoff.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/bin_entry_point.py` & `portage-3.0.48.1/lib/portage/util/bin_entry_point.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/changelog.py` & `portage-3.0.48.1/lib/portage/util/changelog.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/compression_probe.py` & `portage-3.0.48.1/lib/portage/util/compression_probe.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/configparser.py` & `portage-3.0.48.1/lib/portage/util/configparser.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/cpuinfo.py` & `portage-3.0.48.1/lib/portage/util/cpuinfo.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/digraph.py` & `portage-3.0.48.1/lib/portage/util/digraph.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/elf/constants.py` & `portage-3.0.48.1/lib/portage/util/elf/constants.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/elf/header.py` & `portage-3.0.48.1/lib/portage/util/elf/header.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/endian/decode.py` & `portage-3.0.48.1/lib/portage/util/endian/decode.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/env_update.py` & `portage-3.0.48.1/lib/portage/util/env_update.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/file_copy/__init__.py` & `portage-3.0.48.1/lib/portage/util/file_copy/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/formatter.py` & `portage-3.0.48.1/lib/portage/util/formatter.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/_asyncio/__init__.py` & `portage-3.0.48.1/lib/portage/util/futures/_asyncio/__init__.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/_asyncio/streams.py` & `portage-3.0.48.1/lib/portage/util/futures/_asyncio/streams.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/_sync_decorator.py` & `portage-3.0.48.1/lib/portage/util/futures/_sync_decorator.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/compat_coroutine.py` & `portage-3.0.48.1/lib/portage/util/futures/compat_coroutine.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/executor/fork.py` & `portage-3.0.48.1/lib/portage/util/futures/executor/fork.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/extendedfutures.py` & `portage-3.0.48.1/lib/portage/util/futures/extendedfutures.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/futures.py` & `portage-3.0.48.1/lib/portage/util/futures/futures.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/iter_completed.py` & `portage-3.0.48.1/lib/portage/util/futures/iter_completed.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/retry.py` & `portage-3.0.48.1/lib/portage/util/futures/retry.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/futures/unix_events.py` & `portage-3.0.48.1/lib/portage/util/futures/unix_events.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/hooks.py` & `portage-3.0.48.1/lib/portage/util/hooks.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/install_mask.py` & `portage-3.0.48.1/lib/portage/util/install_mask.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/iterators/MultiIterGroupBy.py` & `portage-3.0.48.1/lib/portage/util/iterators/MultiIterGroupBy.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/lafilefixer.py` & `portage-3.0.48.1/lib/portage/util/lafilefixer.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/listdir.py` & `portage-3.0.48.1/lib/portage/util/listdir.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/locale.py` & `portage-3.0.48.1/lib/portage/util/locale.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/movefile.py` & `portage-3.0.48.1/lib/portage/util/movefile.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/mtimedb.py` & `portage-3.0.48.1/lib/portage/util/mtimedb.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/netlink.py` & `portage-3.0.48.1/lib/portage/util/netlink.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/path.py` & `portage-3.0.48.1/lib/portage/util/path.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/shelve.py` & `portage-3.0.48.1/lib/portage/util/shelve.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/socks5.py` & `portage-3.0.48.1/lib/portage/util/socks5.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/whirlpool.py` & `portage-3.0.48.1/lib/portage/util/whirlpool.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/util/writeable_check.py` & `portage-3.0.48.1/lib/portage/util/writeable_check.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/versions.py` & `portage-3.0.48.1/lib/portage/versions.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/xml/metadata.py` & `portage-3.0.48.1/lib/portage/xml/metadata.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/lib/portage/xpak.py` & `portage-3.0.48.1/lib/portage/xpak.py`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/misc/emerge-delta-webrsync` & `portage-3.0.48.1/misc/emerge-delta-webrsync`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/setup.py` & `portage-3.0.48.1/setup.py`
...
### Comparing `portage-3.0.48/src/portage_util__whirlpool.c` & `portage-3.0.48.1/src/portage_util__whirlpool.c`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/src/portage_util_file_copy_reflink_linux.c` & `portage-3.0.48.1/src/portage_util_file_copy_reflink_linux.c`

 * *Files identical despite different names*

### Comparing `portage-3.0.48/src/portage_util_libc.c` & `portage-3.0.48.1/src/portage_util_libc.c`
