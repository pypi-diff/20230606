# Comparing `tmp/pankmer-0.12.4.tar.gz` & `tmp/pankmer-0.9.0.tar.gz`
...
## Comparing `pankmer-0.12.4.tar` & `pankmer-0.9.0.tar`

### file list

```diff
@@ -1,32 +1,34 @@
--rw-r--r--   0        0        0      654 1970-01-01 00:00:00.000000 pankmer-0.12.4/rust/Cargo.toml
--rw-r--r--   0      501       20      453 2023-05-02 18:45:46.000000 pankmer-0.12.4/rust/Cargo_backup.toml
--rw-r--r--   0      501       20     2446 2023-06-01 18:28:18.000000 pankmer-0.12.4/rust/src/adj_matrix.rs
--rw-r--r--   0      501       20     2172 2023-06-06 20:14:06.000000 pankmer-0.12.4/rust/src/decompose_kmers.rs
--rw-r--r--   0      501       20     5819 2023-06-06 21:06:46.000000 pankmer-0.12.4/rust/src/get_kmers.rs
--rw-r--r--   0      501       20     1079 2023-06-01 18:28:18.000000 pankmer-0.12.4/rust/src/helpers.rs
--rw-r--r--   0      501       20     8435 2023-06-05 23:28:10.000000 pankmer-0.12.4/rust/src/lib.rs
--rw-r--r--   0      501       20     1535 2023-06-06 20:14:06.000000 pankmer-0.12.4/rust/src/mem_blocks.rs
--rw-r--r--   0      501       20     3484 2023-06-01 18:28:18.000000 pankmer-0.12.4/rust/src/metadata.rs
--rw-r--r--   0      501       20    10541 2023-06-06 20:14:06.000000 pankmer-0.12.4/rust/src/pkidx.rs
--rw-r--r--   0      501       20     5052 2023-06-06 20:14:06.000000 pankmer-0.12.4/rust/src/score_list_io.rs
--rw-r--r--   0      501       20     1151 2023-06-06 20:14:06.000000 pankmer-0.12.4/pyproject.toml
--rw-r--r--   0      501       20    32404 2023-06-06 19:43:31.000000 pankmer-0.12.4/rust/Cargo.lock
--rw-r--r--   0      501       20     6062 2023-02-24 00:04:09.000000 pankmer-0.12.4/src/pankmer/tree.py
--rw-r--r--   0      501       20     4443 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/collect.py
--rw-r--r--   0      501       20       58 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/version.py
--rw-r--r--   0      501       20    17939 2023-02-24 00:04:09.000000 pankmer-0.12.4/src/pankmer/env.py
--rw-r--r--   0      501       20     3314 2023-05-02 18:45:46.000000 pankmer-0.12.4/src/pankmer/clustermap.py
--rw-r--r--   0      501       20      214 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/get_lower_bound.py
--rw-r--r--   0      501       20     1493 2023-02-24 00:04:09.000000 pankmer-0.12.4/src/pankmer/download.py
--rw-r--r--   0      501       20      313 2023-06-06 20:14:06.000000 pankmer-0.12.4/src/pankmer/__init__.py
--rw-r--r--   0      501       20     1815 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/adjacency_matrix.py
--rw-r--r--   0      501       20     1930 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/upset.py
--rw-r--r--   0      501       20     3244 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/subset.py
--rw-r--r--   0      501       20      534 2023-05-02 18:45:46.000000 pankmer-0.12.4/src/pankmer/gzip_agnostic_open.py
--rw-r--r--   0      501       20    18612 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/reg_coverage.py
--rw-r--r--   0      501       20     2847 2023-06-02 02:38:14.000000 pankmer-0.12.4/src/pankmer/anchormap.py
--rw-r--r--   0      501       20      757 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/count.py
--rw-r--r--   0      501       20     2320 2023-06-01 18:28:18.000000 pankmer-0.12.4/src/pankmer/dryrun.py
--rw-r--r--   0      501       20    58388 2023-06-06 20:47:20.000000 pankmer-0.12.4/src/pankmer/pankmer.py
--rw-r--r--   0      501       20     4224 2023-06-05 23:44:20.000000 pankmer-0.12.4/README.md
--rw-r--r--   0        0        0     5205 1970-01-01 00:00:00.000000 pankmer-0.12.4/PKG-INFO
...
### Comparing `pankmer-0.12.4/pyproject.toml` & `pankmer-0.9.0/pyproject.toml`
...
+build-backend = "setuptools.build_meta"
 ...
 [project]
 name = "pankmer"
-version = "0.12.4" # Don't forget to match with Cargo.toml and docs/source/conf.py
...
### Comparing `pankmer-0.12.4/src/pankmer/tree.py` & `pankmer-0.9.0/src/pankmer/tree.py`

 * *Files identical despite different names*

### Comparing `pankmer-0.12.4/src/pankmer/env.py` & `pankmer-0.9.0/src/pankmer/env.py`

 * *Files identical despite different names*

### Comparing `pankmer-0.12.4/src/pankmer/clustermap.py` & `pankmer-0.9.0/src/pankmer/clustermap.py`
...
### Comparing `pankmer-0.12.4/src/pankmer/download.py` & `pankmer-0.9.0/src/pankmer/download.py`

 * *Files identical despite different names*

### Comparing `pankmer-0.12.4/src/pankmer/adjacency_matrix.py` & `pankmer-0.9.0/src/pankmer/adjacency_matrix.py`
...
### Comparing `pankmer-0.12.4/src/pankmer/reg_coverage.py` & `pankmer-0.9.0/src/pankmer/reg_coverage.py`
...
### Comparing `pankmer-0.12.4/src/pankmer/count.py` & `pankmer-0.9.0/src/pankmer/count.py`
...
### Comparing `pankmer-0.12.4/src/pankmer/pankmer.py` & `pankmer-0.9.0/src/pankmer/pankmer.py`
...
### Comparing `pankmer-0.12.4/README.md` & `pankmer-0.9.0/README.md`
...
### Comparing `pankmer-0.12.4/PKG-INFO` & `pankmer-0.9.0/PKG-INFO`
