# Comparing `tmp/irene_pro-0.0.49.tar.gz` & `tmp/irene_pro-0.0.50.tar.gz`
...
## Comparing `irene_pro-0.0.49.tar` & `irene_pro-0.0.50.tar`
...
### Comparing `irene_pro-0.0.49/PKG-INFO` & `irene_pro-0.0.50/PKG-INFO`
...
### Comparing `irene_pro-0.0.49/README.md` & `irene_pro-0.0.50/README.md`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.49/irene_pro/logic.py` & `irene_pro-0.0.50/irene_pro/logic.py`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.49/irene_pro/widgets.py` & `irene_pro-0.0.50/irene_pro/widgets.py`
...
### Comparing `irene_pro-0.0.49/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.50/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.49/setup.py` & `irene_pro-0.0.50/setup.py`
