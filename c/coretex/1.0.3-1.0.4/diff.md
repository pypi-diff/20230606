# Comparing `tmp/coretex-1.0.3.tar.gz` & `tmp/coretex-1.0.4.tar.gz`
...
### Comparing `coretex-1.0.3/src/coretex/coretex/experiment/metrics/predefined_metrics/download_speed.py` & `coretex-1.0.4/src/coretex/coretex/experiment/metrics/predefined_metrics/download_speed.py`
...
### Comparing `coretex-1.0.3/src/coretex/coretex/model/__init__.py` & `coretex-1.0.4/src/coretex/coretex/model/__init__.py`
...
### Comparing `coretex-1.0.3/src/coretex/coretex/sample/network_sample.py` & `coretex-1.0.4/src/coretex/coretex/sample/network_sample.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/coretex/sample/sample.py` & `coretex-1.0.4/src/coretex/coretex/sample/sample.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/coretex/space/__init__.py` & `coretex-1.0.4/src/coretex/coretex/space/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/coretex/space/base.py` & `coretex-1.0.4/src/coretex/coretex/space/base.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/coretex/space/project.py` & `coretex-1.0.4/src/coretex/coretex/space/project.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/coretex/space/space.py` & `coretex-1.0.4/src/coretex/coretex/space/space.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/coretex/space/space_task.py` & `coretex-1.0.4/src/coretex/coretex/space/space_task.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/folder_management/__init__.py` & `coretex-1.0.4/src/coretex/folder_management/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/folder_management/folder_manager.py` & `coretex-1.0.4/src/coretex/folder_management/folder_manager.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/logging/__init__.py` & `coretex-1.0.4/src/coretex/logging/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/logging/log.py` & `coretex-1.0.4/src/coretex/logging/log.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/logging/log_severity.py` & `coretex-1.0.4/src/coretex/logging/log_severity.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/logging/logger.py` & `coretex-1.0.4/src/coretex/logging/logger.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/__init__.py` & `coretex-1.0.4/src/coretex/networking/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/chunk_upload_session.py` & `coretex-1.0.4/src/coretex/networking/chunk_upload_session.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/file_data.py` & `coretex-1.0.4/src/coretex/networking/file_data.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/network_manager.py` & `coretex-1.0.4/src/coretex/networking/network_manager.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/network_manager_base.py` & `coretex-1.0.4/src/coretex/networking/network_manager_base.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/network_object.py` & `coretex-1.0.4/src/coretex/networking/network_object.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/network_response.py` & `coretex-1.0.4/src/coretex/networking/network_response.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/request_type.py` & `coretex-1.0.4/src/coretex/networking/request_type.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/requests_manager.py` & `coretex-1.0.4/src/coretex/networking/requests_manager.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/networking/user_data.py` & `coretex-1.0.4/src/coretex/networking/user_data.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/nlp/__init__.py` & `coretex-1.0.4/src/coretex/nlp/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/nlp/text.py` & `coretex-1.0.4/src/coretex/nlp/text.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/nlp/token.py` & `coretex-1.0.4/src/coretex/nlp/token.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/nlp/transcriber.py` & `coretex-1.0.4/src/coretex/nlp/transcriber.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/nlp/transcription.py` & `coretex-1.0.4/src/coretex/nlp/transcription.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/nlp/utils.py` & `coretex-1.0.4/src/coretex/nlp/utils.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/project/__init__.py` & `coretex-1.0.4/src/coretex/project/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/project/base.py` & `coretex-1.0.4/src/coretex/project/base.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/project/calculate_metrics.py` & `coretex-1.0.4/src/coretex/project/calculate_metrics.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/project/heartbeat.py` & `coretex-1.0.4/src/coretex/project/heartbeat.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/project/local.py` & `coretex-1.0.4/src/coretex/project/local.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/project/remote.py` & `coretex-1.0.4/src/coretex/project/remote.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/qiime2/__init__.py` & `coretex-1.0.4/src/coretex/qiime2/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/qiime2/utils.py` & `coretex-1.0.4/src/coretex/qiime2/utils.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/threading/__init__.py` & `coretex-1.0.4/src/coretex/threading/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/threading/threaded_data_processor.py` & `coretex-1.0.4/src/coretex/threading/threaded_data_processor.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/utils/__init__.py` & `coretex-1.0.4/src/coretex/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/utils/console_progress_bar.py` & `coretex-1.0.4/src/coretex/utils/console_progress_bar.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/utils/date.py` & `coretex-1.0.4/src/coretex/utils/date.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/utils/file.py` & `coretex-1.0.4/src/coretex/utils/file.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex/utils/number.py` & `coretex-1.0.4/src/coretex/utils/number.py`

 * *Files identical despite different names*

### Comparing `coretex-1.0.3/src/coretex.egg-info/PKG-INFO` & `coretex-1.0.4/src/coretex.egg-info/PKG-INFO`
...
### Comparing `coretex-1.0.3/src/coretex.egg-info/SOURCES.txt` & `coretex-1.0.4/src/coretex.egg-info/SOURCES.txt`
